...
:::caution
To accurately get the current addresses of bridge smart contracts, see them directly in the [network config](/crosschain/overview?id=network-configs). It's the most secure way.
:::
