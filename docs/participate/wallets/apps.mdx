...
* [TON Wallet CLI](https://github.com/moorzeen/ton-wallet-cli) — an open-source command-line wallet.
...
| TON Wallet CLI | Not implemented | -                                                                     | -                                                           | [wallet v4](https://github.com/ton-blockchain/wallet-contract/tree/3fd1d7ae39f1c46ec1f2be54c4040d8d87505e0f)               |
...
[TON Wallet CLI](https://github.com/moorzeen/ton-wallet-cli) - this is an open-source command-line wallet with the ability to find wallet addresses with desired suffixes.


|                                                                                                                                                                                                                                   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;![TON Wallet CLI](/img/docs/wallet-apps/TONWalletCLI.png?raw=true) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; |




#### Pros and Cons
- ✅ CLI basic features implemented.
- ✅ Unique feature - find addresses with specified suffix.
- ✅ Supports all major platforms (such as macOS, Linux and Windows).
- ❌ Doesn't work in Firefox as an extension.

#### TON Wallet CLI test environment
To run in testnet add `--testnet` as the last flag in the command line.

#### Links

- [GitHub](https://github.com/moorzeen/ton-wallet-cli)
