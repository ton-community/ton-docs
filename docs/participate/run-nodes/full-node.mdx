...
| Vultr            | `bare metal Intel E-2388G` | `32 Cores / 32 Threads` | `128GB` | `1.92TB NVMe SSD` | `10 Gbps` | Fixed IP address included with instance | `16 TB/month`|
...
| Latitude         | `c3.medium.x86`       | `32 Cores / 32 Threads` | `128GB` | `1.9TB NVMe SSD` | `10 Gbps` | Fixed IP address included with instance | `16 TB/month`|
