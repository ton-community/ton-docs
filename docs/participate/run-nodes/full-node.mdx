...
### Local Validator Status command does not show the status properly

Typically this means, something went wrong during installation and the step of creating/assigning a validator wallet was skipped.
