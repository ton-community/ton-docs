...
Read more about `max_validators` and `max_main_validators` [on config parameters page](https://docs.ton.org/develop/howto/blockchain-configs#configuration-parameters-for-the-number-of-validators-for-elections). Get the actual values [for mainnet](https://tonviewer.com/config#16) and [for testnet](https://testnet.tonviewer.com/config#16).
