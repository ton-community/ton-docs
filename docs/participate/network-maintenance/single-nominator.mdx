...
You can also make a deposit using mytonctrl, using the following command:
...
It's possible to return coins partly, but you need to create and send transaction manually:
