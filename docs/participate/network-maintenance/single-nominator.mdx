...
Find your node as potential validator under **Validator Index** by checking the Validators List with `vl` command:

![](/img/docs/single-nominator/vl-activated.png)
...
1. Set stake 0 to discontinue election participation.
