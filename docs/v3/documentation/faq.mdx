...
- [Comparison of Blockchains table (much less informative than the document, but more visual)](/v3/concepts/dive-into-ton/go-from-ethereum/blockchain-comparison)
  :::
...
- [NFT documentation](/v3/documentation/dapps/assets/jetton#nft)
...
- [Fungible token documentation (Jettons)](/v3/documentation/dapps/assets/jetton#jettons-fungible-tokens)
