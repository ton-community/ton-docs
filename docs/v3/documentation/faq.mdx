...
- [Comparison of blockchains table](/v3/concepts/dive-into-ton/ton-blockchain/blockchain-comparison)
...
For more up-to-date parameters, refer to the [Config parameters](/v3/documentation/network/configs/blockchain-configs) 
