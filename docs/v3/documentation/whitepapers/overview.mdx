...
:::info
The code, comments, and documentation may reference "gram" and "nanogram." These are remnants of the original TON code developed by Telegram. The Gram cryptocurrency was never issued; the TON Testnet uses Test Toncoin. The official currency of TON is Toncoin.
:::
