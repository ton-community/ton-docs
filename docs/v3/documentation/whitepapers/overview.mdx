...
:::info
The code, comments, and documentation may reference "gram" and "nanogram." These are remnants of the original TON code developed by Telegram. The Gram cryptocurrency was never issued; The official currency of TON is Toncoin, the TON Testnet uses Test Toncoin. 
:::

- [TON Whitepaper](https://docs.ton.org/ton.pdf): an overview of the TON (The Open Network) Blockchain.

- [TON Virtual Machine](https://docs.ton.org/tvm.pdf): the TON Virtual Machine whitepaper may contain outdated opcode information; the current list is available in the [TVM instructions](/v3/documentation/tvm/instructions) section.

- [TON Blockchain](https://docs.ton.org/tblkch.pdf): a description that may contain outdated information.
