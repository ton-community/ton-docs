...
Tact is a fresh programming language for TON Blockchain that focuses on efficiency and ease of development, offering familiar syntax to TypeScript, Rust and Kotlin developers. Tact is designed to be beginner-friendly, which significantly reduces the onboarding time and fosters adoption of TON.

Simplify TON development and rapidly prototype your contracts with Tact!
