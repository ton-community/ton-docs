...
TON Testnet is an independent blockchain network that replicates the Mainnet’s functionality, using valueless tokens.

Use TON Testnet to safely develop and debug before deploying to Mainnet.

:::info
Coins in the test network have no value.
:::

## Key resources for getting started with TON Testnet

<Button href="https://ton.org/testnet-global.config.json" colorType="primary" sizeType={'sm'}>
  Testnet global config
</Button>
...
| TON Center (Testnet)      | [testnet.toncenter.com](https://testnet.toncenter.com) |
| TonAPI (Testnet)        | [testnet.tonapi.io](https://testnet.tonapi.io/) |
...
- [Ton Sandbox Explorer (Testnet)](https://tonsandbox.com/explorer)
