...
- Take applications with stake ≥ `min_stake` ([**ConfigParam 17**](/v3/documentation/network/config-params/overview#param-17)).
- Arrange candidates by stake in descending order.
- If applicants exceed `max_validators` ([**ConfigParam 16**](/v3/documentation/network/config-params/overview#param-16)), discard the lowest-staked candidates.
...
The Elector registers the complaint in the `past_elections` hashmap. Current round validators then verify the complaint. If the proof is valid, validators vote on the complaint. Approval requires agreement from more than **three-quarters of the total validator weight** and follows the wins/losses limits defined in [**ConfigParam 11**](/v3/documentation/network/config-params/overview#param-11) (not just a majority of participants).

If approved, the fine (as determined by [**ConfigParam 40**](/v3/documentation/network/config-params/overview#param-40) — MisbehaviourPunishmentConfig) is deducted from the validator's `frozen` stake in the relevant `past_elections` record. These funds stay locked for the period defined by [**ConfigParam 15**](/v3/documentation/network/config-params/overview#param-15) (`stake_held_for`).
...
2. **Config** stores it in [**ConfigParam 36**](/v3/documentation/network/config-params/overview#param-32-34-and-36) (_next validators_).
...
3. **Outcome**:
   ...
   - _Critical parameters_ ([**ConfigParam 10**](/v3/documentation/network/config-params/overview#param-10)) require more rounds.
