...
Configure the Single Nominator Pool contract using the [following]((/v3/documentation/smart-contracts/contracts-specs/single-nominator-pool#set-up-single-nominator)) instructions.

### Join the elections

[Deposit](/v3/documentation/smart-contracts/contracts-specs/single-nominator-pool#deposit-pool) minimum stake amount to the Single Nominator Pool.
...
2. [Withdraw](/v3/documentation/smart-contracts/contracts-specs/single-nominator-pool#withdraw-funds) all funds from the Single Nominator contract to the owner wallet.
...
3. Proceed with the following [steps](/v3/documentation/smart-contracts/contracts-specs/single-nominator-pool#set-up-single-nominator).


## See Also

* [Single Nominator Pool contract](https://github.com/orbs-network/single-nominator)
* [Vesting Contract](/v3/documentation/smart-contracts/contracts-specs/vesting-contract)
