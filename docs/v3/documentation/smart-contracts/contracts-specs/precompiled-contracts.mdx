...
2. If the contract balance cannot cover the `gas_usage` cost, the compute phase fails with [`cskip_no_gas`](/v3/documentation/tvm/overview#when-the-compute-phase-is-skipped)
