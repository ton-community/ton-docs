...
- The `gas_limit` is initially set to `gas_credit` [Param20/Param21](/v3/documentation/network/config-params/overview#param-20-and-21), which equals 10k gas units.
