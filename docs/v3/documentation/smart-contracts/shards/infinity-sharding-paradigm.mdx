...
Validators decide to split or merge shards using `want_split` and `want_merge` flags and [workchain configuration parameters](/v3/documentation/network/config-params/overview#param-12).
