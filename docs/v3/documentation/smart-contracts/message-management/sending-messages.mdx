...
Composition, parsing, and sending messages lie at the intersection of [TL-B schemas](/v3/documentation/data-formats/tlb/overviewe), [transaction phases, and TVM](/v3/documentation/tvm/overview).
