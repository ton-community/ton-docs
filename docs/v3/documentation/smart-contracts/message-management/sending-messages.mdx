...
Composition, parsing, and sending messages lie at the intersection of [TL-B schemas](/v3/documentation/data-formats/tlb/overview), [transaction phases, and TVM](/v3/documentation/tvm/overview).
...
:::info cell size
Note that any [Cell](/v3/concepts/dive-into-ton/ton-blockchain/cells) may contain up to `1023` bits. If you need to store more data, you should split it into chunks and store it in reference cells.
:::
...
More configuration parameters and their values can be found [here](/v3/documentation/network/config-params/overview#param-43).
:::
