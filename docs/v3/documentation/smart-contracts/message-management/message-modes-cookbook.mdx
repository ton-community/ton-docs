...
| Outbound fees (per message)                                                                            | 0.001       | fwd_fee + action_fee + ihr_fee  |
...
| [Forward fee](/v3/documentation/smart-contracts/transaction-fees/fees-low-level#forward-fees) (each msg) | 0.000266669 | cost of fwd of in_msg           |
