...
State after error: Account A has 1 - ([total_fee](/v3/documentation/smart-contracts/transaction-fees/fees#basic-fees-formula) + `fwd_fee`) TON, Account B has 1 TON
...
State after tx: Account A has 0.896 TON, Account B has 1.1 TON
...
State before tx: Account A has 1 TON, Account B has 1 TON, Account C has 1 TON
...
State after tx: Account A has 0.896 TON, Account B has 0.5 TON, Account C has 1.596 TON
...
State after tx: Account A has 0.896 TON, Account B has 0.496 TON, Account C has 1.6 TON
// example should be added
...
State after error: Account A has 1 - (total_fee + `fwd_fee`) TON, Account B has 1 TON, Account C has 1 TON
// example should be added
...
State after tx: Account A has 0.896 TON, Account B has 0 TON, Account C has ~2.09 TON
...
State after tx: Account A has 0.896 TON, Account B has 0 TON and `nonexist`, Account C has ~2.09 TON
