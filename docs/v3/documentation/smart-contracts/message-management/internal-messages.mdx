...
2. Let `salt` be the [bas64url representation](/v3/documentation/smart-contracts/address-formats) of the sender wallet address with `isBounceable=1` and `isTestnetOnly=0`.
