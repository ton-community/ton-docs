...
=======
-   **workchain_id**: a signed 32-bit integer identifying the workchain.<br/>
Examples: `-1` for the masterchain and `0` for the basic workchain.
>>>>>>> pitaya/doc-fix/run_20250901_144329_2bdedc55/k8c2a7e49
...
A CRC16-CCITT checksum validates the preceding 34 bytes to detect input errors.

#### Flag definitions  
The flags byte encodes bounceability and test-only; its top 6 bits determine the first base64 character, as defined in [TEP-2](https://github.com/ton-blockchain/TEPs/blob/master/text/0002-address.md):  
...
Additional binary data related to TON Blockchain employs similar armored base64 representations. For example, 256-bit Ed25519 public keys are represented by first creating a 36-byte sequence consisting of:
=======
-   **SDKs**: see conversion examples in the [Cookbook](/v3/guidelines/dapps/cookbook#how-to-convert-between-user-friendly-and-raw-addresses-assemble-and-extract-them-from-strings) and the [SDKs page](/v3/guidelines/dapps/apis-sdks/sdk). For reference, see `Address.spec.ts` in ton-core: https://github.com/ton-org/ton-core/blob/main/src/address/Address.spec.ts
