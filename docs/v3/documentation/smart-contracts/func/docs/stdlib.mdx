...
Loads a serialized amount of Toncoins, which is an unsigned integer up to `2^120 - 1`.
...
Learn more in the [TVM instruction](/v3/documentation/tvm/overview) section.
