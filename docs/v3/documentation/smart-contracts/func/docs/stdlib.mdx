...
Returns the tail and then the head of a lisp-style list (in that order). It can be used as a [(non-)modifying method](/v3/documentation/smart-contracts/func/docs/statements#methods-calls).
