...
Developers and engineers can use its bytecode, which is structured as a [tree of cells](/v3/concepts/dive-into-ton/ton-blockchain/cells/) like all data in the TON Blockchain, to create smart contracts or run it on a local instance of the TVM.
