...
The [TON Blockchain Course](https://stepik.org/course/176754/) is a comprehensive guide to the TON Blockchain development.

Module 4 covers FunC language and smart contracts development.
...
* [FunC quiz (RU)](https://t.me/toncontests/58?comment=14888/) - _Vadim_ - FunC quiz in Russian
