...
Install Node.js (version 16 or higher) and npm.js.
...
## Project structure:
   ...
   ├── contracts/         # Smart contract source code on Tolk (e.g., counter.tolk)
   ├── scripts/           # TypeScript deployment scripts
   ├── tests/             # TypeScript tests
   ├── wrappers/          # TypeScript smart contract wrappers for scripts and tests
   ```
## Build
...
Tolk is supported by the IntelliJ IDE and VSCode plugins.
