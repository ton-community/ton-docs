...
4. Gas-efficient by design — contracts can cost up to **50% less** than FunC equivalents thanks to compiler optimizations and **lazy** functionality.
...
2. [Set up](https://ton.org/v3/documentation/smart-contracts/tolk/environment-setup.mdx) the first Tolk counter project using
