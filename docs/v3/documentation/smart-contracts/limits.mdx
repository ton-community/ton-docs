...
| `flat_gas_limit`    | Gas below `flat_gas_limit` is provided at the price of `flat_gas_price` | 100      | uint64     | [config21](/v3/documentation/network/configs/blockchain-configs#param-20-and-21)        |
...
| Name               | Description                                  | Value      | Type   | Defined&nbsp;in |
| ------------------ | -------------------------------------------- | ---------- | ------ | --------------- |
| `freeze_due_limit` | Storage fees (nanotons) for contract freezing | 100000000  | uint64 | [config21](/v3/documentation/network/configs/blockchain-configs#param-20-and-21)        |
| `delete_due_limit` | Storage fees (nanotons) for contract deletion | 1000000000 | uint64 | [config21](/v3/documentation/network/configs/blockchain-configs#param-20-and-21)        |
...
| `bit_price`  | Cost per 65536 bits of message forwarding             | 26214400   | uint64 | [config25](/v3/documentation/network/configs/blockchain-configs#param-24-and-25)        |
| `cell_price` | Cost per 65536 cells for message forwarding           | 2621440000 | uint64 | [config25](/v3/documentation/network/configs/blockchain-configs#param-24-and-25)        |
...
| `mc_bit_price`           | Cost per 65536 bits of message forwarding        | 655360000   | uint64 | [config24](/v3/documentation/network/configs/blockchain-configs#param-24-and-25)        |
| `mc_cell_price`          | Cost per 65536 cells for message forwarding      | 65536000000 | uint64 | [config24](/v3/documentation/network/configs/blockchain-configs#param-24-and-25)        |
