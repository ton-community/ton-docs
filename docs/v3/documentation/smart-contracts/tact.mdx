...
- a convenient `unboc` disassembler of a contract's code compiled into a [bag of cells](/v3/documentation/data-formats/cells/overview#bag-of-cells) `.boc` format.
