...
:::caution
For the most accurate current addresses of bridge smart contracts, refer to the [Blockchain configurations](/v3/documentation/infra/crosschain/overview#blockchain-configurations).
:::

## Toncoin Mainnet oracles
...
> These token oracles are the same as the Toncoin Testnet oracles listed above.
