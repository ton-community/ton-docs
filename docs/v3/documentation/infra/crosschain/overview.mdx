...
The Toncoin bridge enables transfers of Toncoin between TON and the Ethereum blockchain and between TON and the BSC (BNB Smart Chain).
...
See also the internal reference for parameters 71–73: [/v3/documentation/network/configs/blockchain-configs#param-71-73](/v3/documentation/network/configs/blockchain-configs#param-71-73).
