...
2. If you cannot set up your TON node with a liteserver, you can use public liteservers from the global config provided by the TON Foundation. For this purpose, use the following configuration files:
