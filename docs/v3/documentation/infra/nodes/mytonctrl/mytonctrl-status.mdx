...
check [this (param 32-34-and-36) section](/v3/documentation/network/configs/blockchain-configs#param-32-34-and-36) for more.
...
Configurator address, check [this param 0](/v3/documentation/network/configs/blockchain-configs#param-0) for more.

### Elector address

Elector address, check [this param 1](/v3/documentation/network/configs/blockchain-configs#param-1) for more.

### Validation period

Validation period in seconds, check [this param 15](/v3/documentation/network/configs/blockchain-configs#param-15) for more.

### Duration of elections

Duration of elections in seconds, check [this param 15](/v3/documentation/network/configs/blockchain-configs#param-15) for more.

### Hold period

Hold period in seconds, check [this param 15](/v3/documentation/network/configs/blockchain-configs#param-15) for more.

### Minimum stake

Minimum stake in TONs, check [this param 17](/v3/documentation/network/configs/blockchain-configs#param-17) for more.

### Maximum stake

Maximum stake in TONs, check [this param 17](/v3/documentation/network/configs/blockchain-configs#param-17) for more.
