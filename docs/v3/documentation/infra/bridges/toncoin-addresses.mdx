...
:::caution
For the most accurate current addresses of bridge smart contracts, refer to the [Blockchain configurations](/v3/documentation/infra/bridges/toncoin#blockchain-configurations).
:::
