...
# Toncoin bridges addresses

:::caution
For the most accurate current addresses of bridge smart contracts, please refer to the [blockchain config](/v3/documentation/infra/bridges/toncoin#blockchain-configs). This is the most secure method.
:::
