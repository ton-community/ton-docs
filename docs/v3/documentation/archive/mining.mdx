...
4. Check your hardware and [expected mining income](/v3/documentation/archive/mining#income-estimates) by running the `emi` command within `mytonctrl`.
...
### <a id="hardware-estimates" />Income estimates
...
#### <a id="faq-general-elite" />Is it difficult to start mining?
...
#### <a id="faq-general-stats" />Where can I see mining statistics?
...
#### <a id="faq-mining-giver" />Which giver should I mine?
...
### <a id="faq-hw" />Hardware

#### <a id="faq-hw-machine" />Will a faster machine always win?
...
#### <a id="faq-hw-mc" />If I run many machines, will they cooperate?
