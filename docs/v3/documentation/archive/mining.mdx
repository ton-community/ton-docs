...
4. Check your hardware and [expected mining income](/v3/documentation/archive/mining#hardware-estimates) by running `emi` command within `mytonctrl`.
