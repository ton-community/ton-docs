...
The address of the configurator. Refer to [this parameter-0](/v3/documentation/network/config-params/overview#param-0) for more information.

### Elector address

The address of the elector. Refer to [this parameter-1](/v3/documentation/network/config-params/overview#param-1) for additional details.

### Validation period

The duration of the validation period in seconds. Check [this parameter-15](/v3/documentation/network/config-params/overview#param-15).

### Duration of elections

This refers to the duration of elections in seconds. To know more, refer to [this parameter-15](/v3/documentation/network/config-params/overview#param-15).

### Hold period

The hold period in seconds, with details available at [this parameter-15](/v3/documentation/network/config-params/overview#param-15).

### Minimum stake

The minimum stake required in TONs. Check [this parameter-17](/v3/documentation/network/config-params/overview#param-17).

### Maximum stake

The maximum stake allowed in TONs. Check [this parameter-17](/v3/documentation/network/config-params/overview#param-17).
