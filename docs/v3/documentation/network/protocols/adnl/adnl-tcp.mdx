...
- (N - 64) payload bytes
- 32 bytes SHA-256 checksum from nonce and payload
...
- \[32 bytes] **SHA-256 hash from our 160 bytes**
...
- 32 bytes of SHA-256 checksum from nonce and payload
...
- 32 bytes `query_id:int256` -> random 32 bytes
  ...
  - 3 zero bytes of padding (padded to a 4-byte boundary) ([details](/v3/documentation/data-formats/tl/#encoding-bytes-array))
- 32 bytes of checksum SHA-256 from nonce and payload
