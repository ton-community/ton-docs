...
Let's analyze **runSmcMethod** - this is a method that calls a function from a smart contract and returns a result. Here we need to understand some new data types such as [TL-B](/v3/documentation/data-formats/tlb/overview), [Cell](/v3/documentation/data-formats/cells/overview#cell) and [BoC](/v3/documentation/data-formats/cells/overview#bag-of-cells).
