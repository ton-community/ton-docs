...
Here is the [link to the original article](https://github.com/xssnick/ton-deep-doc/blob/master/ADNL-UDP-Internal.mdx) - _[Oleg Baranov](https://github.com/xssnick)._
<Feedback />
