...
Here is the [link to the original article](https://github.com/xssnick/ton-deep-doc/blob/master/Overlay-Network.mdx) - _[Oleg Baranov](https://github.com/xssnick)._
