...
Now we can begin our search. To do this, we need to execute a query that has [schema](https://github.com/ton-blockchain/ton/blob/ee42357f5954f777d7ebd937b2683096da3699bf/tl/generate/scheme/ton_api.tl#L202):
