...
* [TON Hello World: Step-by-step guide for writing your first smart contract](https://helloworld.tonstudio.io/02-contract/) - An accessible and concise explanation of the fundamentals with JS.
