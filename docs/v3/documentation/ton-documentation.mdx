...
* [TON Hello World: Step-by-step guide for writing your first smart contract](https://ton-community.github.io/tutorials/02-contract/) - a step-by-step guide for writing your first smart contract. Offers an accessible and concise introduction to the fundamentals of using JavaScript.
