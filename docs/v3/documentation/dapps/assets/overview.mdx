...
- TON supports up to 2^32 extra currencies; accounts and messages support them, but no extra currency has been created on the TON Blockchain yet—the minter system contract for their creation has not been deployed. See [Extra currencies](/v3/documentation/dapps/assets/extra-currencies) for more details.
