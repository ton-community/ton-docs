...
It assumes you are familiar with [exotic cells](/v3/documentation/data-formats/cells/exotic) and the [TL-B language](/v3/documentation/data-formats/tlb/overview)
