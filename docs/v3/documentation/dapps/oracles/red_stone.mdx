...
To define the initial (storage) data for the SampleConsumer contract, use the predefined
...
Due to Bag of Cells (BoC) size limitations (see /v3/documentation/data-formats/tlb/cell-boc),
