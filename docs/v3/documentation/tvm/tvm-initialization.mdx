...
it is highly recommended to familiarize yourself with the [TL-B language](/v3/documentation/data-formats/tlb/tl-b-language).
...
- Control register **c3** is initialized with the smart contract code cell.
...
- For external messages, the initial current gas limit _g_<sub>l</sub> equals the initial gas credit _g_<sub>c</sub>.
...
- Original description of [TVM initialization](/tblkch.pdf#page=89&zoom=100) from the whitepaper
<Feedback />
