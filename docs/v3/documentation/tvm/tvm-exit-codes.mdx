...
- `max_ext_msg_size` — maximum external message size in bits (default `max_size = 65535` bytes).
- `max_ext_msg_depth` — maximum external message depth (default `max_depth = 512`).
