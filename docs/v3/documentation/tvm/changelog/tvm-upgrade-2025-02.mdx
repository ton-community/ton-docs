...
This update is enabled with [Config8 `version >= 9`](../../network/configs/blockchain-configs.mdx#param-9).
...
| `GETGASFEESIMPLE`     | _`gas_used is_mc - price`_           | Computes additional gas cost using `(gas_used * price) / 2^16`.                                                                                                                                                                                                                                   |
| `GETFORWARDFEESIMPLE` | _`cells bits is_mc - price`_         | Computes additional forwarding fee using `(bits * bit_price + cells * cell_price) / 2^16`.                                                                                                                                                                                                        |
