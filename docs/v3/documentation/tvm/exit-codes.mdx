...
Virtualization error related to [pruned branch cells](/v3/documentation/data-formats/tlb/exotic-cells#pruned-branch). Reserved, but never thrown.
...
If the list of actions contains [exotic cells](/v3/documentation/data-formats/tlb/exotic-cells), an action entry cell does not have references, or some action entry cell couldn't be parsed, an error with exit code 32 is thrown: `Action list is invalid`.
