...
TL-B (Type Language - Binary), a version of [Type Language](/v3/documentation/data-formats/tl), that serves to describe serialization of objects in TON Blockchain.

## Structure

A set of TL-B constructs is referred to as a TL-B document.

A typical TL-B document consists of type declarations, i.e., their constructors, and functional combinators.

Each combinator declaration ends with a semicolon `;`.
