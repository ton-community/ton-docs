...
:::info
It's highly recommended that you familiarize yourself with the [TL-B language](/v3/documentation/data-formats/tlb/tl-b-language) to better understand this page.
:::
...
A transaction is the result of a smart contract processing an incoming message for a particular account; it records state changes, fees, and any outgoing messages.
