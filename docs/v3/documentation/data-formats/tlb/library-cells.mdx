...
A library cell is an [exotic cell](/v3/documentation/data-formats/tlb/exotic-cells#library-reference) that references another static cell by storing its 256-bit hash.
