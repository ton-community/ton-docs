...
TL-B parsers serialize basic [TL-B types](/v3/documentation/data-formats/tlb/types). Each parser implements TL-B types as objects and returns the corresponding serialized binary data.
...
| Python     | [tonpy](https://github.com/disintar/tonpy) (includes support for parsing `.tlb` files) | https://t.me/dtontech  |
