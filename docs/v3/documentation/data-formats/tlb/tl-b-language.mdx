...
| `some` or `some#_`          | Serialize `crc32(equation) \| 0x80000000`. |
...
This technique allows code generation to mark special (exotic) cells when printing a structure and ensures proper validation of structures with special cells.
