...
[General detailed explanations for Hashmaps](/v3/documentation/data-formats/tlb/types#hashmap).
...
| workchain_id | int8        | Required | The WorkChain where the smart contract of the destination address is located.                                          |
