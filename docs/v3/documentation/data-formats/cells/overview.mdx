...
Exotic cells follow different rules for determining their level, which are described in [this](/v3/documentation/data-formats/cells/exotic) article.
...
Exotic cells follow separate rules for computing their higher hashes. These are described in detail in [this](/v3/documentation/data-formats/cells/exotic) article.

## See also

{/* [Original article on RU](https://github.com/xssnick/ton-deep-doc/blob/master/Cells-BoC.md) */}

- [Exotic (special) cells](/v3/documentation/data-formats/cells/exotic)
- [Merkle proofs verifying](/v3/documentation/dapps/proofs)
