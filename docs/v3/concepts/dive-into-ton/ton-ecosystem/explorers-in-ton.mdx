...
A Telegram-based explorer for users and developers, providing detailed blockchain information directly within the messenger.

- Mainnet: [@apitonBot](https://t.me/apitonBot)

Seamlessly share information and metadata about addresses and NFTs directly in private messages and group chats. 

#### Features

- For everyday use in Telegram
- With extended information for developers
