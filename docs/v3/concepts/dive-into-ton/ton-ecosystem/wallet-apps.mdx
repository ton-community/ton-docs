...
Explore the full [ton.org/wallets](https://ton.org/wallets) catalogue for more wallet options.
...
<table style={{ width: '100%', tableLayout: 'fixed' }}>
  ...
  <tr>
    ...
    <td>Open-source wallet commonly used in TON Ecosystem. Supports tokens and NFTs.</td>
    <td>iOS, Android, Chrome, Firefox</td>
    <td>
      1. Create wallet & save recovery phrase.<br />
  ...
  <tr>
    ...
    <td>Open-source web wallet supporting tokens, NFTs, DNS, Sites, Proxy, Magic — also compatible with TRON.</td>
    <td>iOS, Android, Chrome, Firefox</td>
    <td>
    <br />
      1. Open **Settings**.
  ...
  <tr>
    ...
    <td>
      <ul style={{ paddingLeft: '16px', margin: 0 }}>
        ...
        <li>Multiple key and wallet management</li>
      </ul>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <ul style={{ paddingLeft: '16px', margin: 0 }}>
        ...
        <li>Supports Testnet parameter in browser</li>
      </ul>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <ul style={{ paddingLeft: '16px', margin: 0 }}>
        ...
        <li>Multiple wallet support in docs</li>
      </ul>
    </td>
  </tr>
  </tbody>
...
|--------|----------------------------------------------------------------------------------|--------|
| [Ledger](https://www.ledger.com/) | Hardware wallet with offline key storage. Uses Ledger Live app to manage assets. | [TON Blogpost](https://blog.ton.org/ton-is-coming-to-ledger-hardware-wallets)<br/>[Official site](https://www.ledger.com/) |
...
| Wallet | Description | Links                                                                                                             |
|--------|-------------|-------------------------------------------------------------------------------------------------------------------|
| [@wallet](https://t.me/wallet) | Telegram bot for sending, receiving, and trading TON via P2P. Supports Telegram Mini Apps. | —                                                                                                                 |
| [@cryptobot](https://t.me/cryptobot)  | Telegram bot wallet for storing, sending, and exchanging TON. | [Pay API](https://help.crypt.bot/crypto-pay-api)                                                                  |
| [@tonRocketBot](https://t.me/tonRocketBot) | Telegram bot wallet for TON storage, transfers, and trading. | [Exchange API](https://trade.ton-rocket.com/api/), [Pay API](https://pay.ton-rocket.com/api/)                      |
