...
:::info
A Software wallet, more often known as a hot wallet, operates as software on a host device and stores your private keys within its interface. Mostly, these wallets are non-custodial, meaning they give you custody of your keys.
:::
...
TON Wallet was the first step in massively adopting blockchain technology, which is now available to ordinary users. It demonstrates how a wallet should work on the TON Blockchain.
...
[Tonkeeper](https://tonkeeper.com/) is the most downloaded and popular wallet. It was developed by the Tonkeeper team and has active support from both users and developers.
...
1. Create a new regular wallet to claim Recovery Phrase, the 24 key words.
...
[MyTonWallet](https://mytonwallet.io/) is the feature-rich web wallet and browser extension for TON, supporting tokens, NFT, TON DNS, TON Sites, TON Proxy, and TON Magic.
...
You will need to download separate Sandbox application to connect to the Testnet.
