...
1. Cell-based architecture
    - TVM uses a unique [bag of cells](/v3/documentation/data-formats/cells/overview/) model to represent data. Each cell can contain up to 128 data bytes and have up to 4 references to other cells.
