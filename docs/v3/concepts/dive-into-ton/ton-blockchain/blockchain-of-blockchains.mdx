...
- And at the smallest level are **ccountChains**, the individual buildings where accounts reside, keeping track of their own local history of **transactions**, including every action or change that happens to that account.
