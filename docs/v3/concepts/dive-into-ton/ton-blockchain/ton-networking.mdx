...
- **TON Ecosystem services** like TON Proxy, TON Sites, TON Storage, and DApps run on these protocols.
  ...
  Once the more sophisticated network protocols are in place to support the TON Blockchain, they can be used for purposes not necessarily related to the immediate demands of the blockchain itself, thus providing more possibilities and flexibility for creating new services in TON Ecosystem.
