...
Currently, there are five types of cells: one ordinary cell and four [exotic cells](/v3/documentation/data-formats/tlb/exotic-cells).
...
- **Slice** is a flavor for reading cells
