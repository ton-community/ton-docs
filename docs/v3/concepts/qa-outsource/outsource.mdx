...
#### Summary
NonceBlox is a leading Web3 Development and Consulting Studio based in ASIA and MENA regions. Having developed and shipped over 450+ web3 projects in the last few years, it provides end-to-end development for anything related to web3 and blockchain.

#### Workstreams
- TON Mini Apps
- DApps and Smart Contracts Development
- Game Development
- Token Development and Launch Consultation
- NFT and Metaverse Development
- Staking, ReStaking and Vesting Softwares
- DeFi and Wallet Development
- Smart Contract Audits

#### Projects and Clients
- [WEN Tap-a-Meme TON App](https://www.wenwencoin.com)
- [Animoca Brands & Portfolio - nWay, Crazos, etc.](http://www.animocabrands.com)
- [Polygon](http://polygon.technology)
- [The SandBox](http://www.sandbox.game/en)
- [Biconomy](http://www.biconomy.io/)
- [Voxies](http://www.voxies.io/)
- [Treeverse](http://treeverse.net)
- [EmberSword](http://embersword.com)

#### Contacts

- http://nonceblox.com
- info@nonceblox.com
- [@guptaritam](https://t.me/guptaritam)
