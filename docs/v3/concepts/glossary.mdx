...
**DApps** — TON decentralized applications (DApps) run entirely on-chain and rely on smart contracts for computation, storage, and communication.
...
**Durov** — Nikolai Durov is Pavel’s brother, who helped develop VK, Telegram, and TON.
...
**TVL** (Total Value Locked) — the total value of assets currently locked in a specific protocol.
