...
**TVM** — TON Virtual Machine (TVM), a machine behaving like a decentralized computer that computes the state of the TON Blockchain after each new block and executes smart contracts.
