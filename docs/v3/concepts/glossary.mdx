...
**TVM** — Ton Virtual Machine, a machine that behaves like a decentralized computer; it computes the state of the Ton blockchain after each new block and executes smart contracts.
