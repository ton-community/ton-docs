...
4. Visit [`@getmyid_bot`](https://t.me/getmyid_bot) and press the **Start** button. The bot will reply with your `ChatId`; you can use this ID if you wish to receive messages directly to your Telegram account.
