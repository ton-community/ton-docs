...
4. HTTP API integration:
  ...
  # Option 1: Install Python via winget (Windows 10/11)
  winget install -e --id Python.Python.3

  # Option 2: Download installer manually if winget is unavailable
  # https://www.python.org/downloads/windows/
  # Run the installer, then ensure pip is up to date:
  python -m ensurepip --upgrade

  # Finally, install the HTTP API
