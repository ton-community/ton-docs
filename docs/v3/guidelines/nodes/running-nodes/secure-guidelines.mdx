...
- If running a full node, ensure the required UDP port is allowed/forwarded in your firewall. See docs/v3/guidelines/nodes/running-nodes/full-node.mdx#port-forwarding.
