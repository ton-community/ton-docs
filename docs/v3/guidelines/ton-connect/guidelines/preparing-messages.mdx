...
While using TON Connect, you should construct the message body for the payload used in various operations. On this page you can find the most relevant examples of payload for use with the TON Connect SDKs.
...
:::info
Examples provided only for @ton/ton library, however, every version of [SDKs](/v3/guidelines/dapps/apis-sdks/sdk) implementation have similar functions.
:::
