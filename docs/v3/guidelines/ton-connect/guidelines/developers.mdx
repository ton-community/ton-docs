...
- Example of the backend part of the DApp above: [GitHub](https://github.com/ton-connect/demo-dapp-backend)
- Bridge server using Go: [GitHub](https://github.com/ton-connect/bridge)

This kit simplifies the implementation of TON Connect in apps built for the TON Blockchain.
