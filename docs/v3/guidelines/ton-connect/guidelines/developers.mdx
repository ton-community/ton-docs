...
See framework guides for React and client-side JS: [React guide](/v3/guidelines/ton-connect/frameworks/react) and [Web (HTML/JS) guide](/v3/guidelines/ton-connect/frameworks/web).
