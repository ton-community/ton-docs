...
:::info
We recommend using the [@tonconnect/ui-react](https://github.com/ton-connect/sdk/tree/main/packages/ui-react) kit for your DApps. Only use lower-level packages such as [@tonconnect/ui](https://github.com/ton-connect/sdk/tree/main/packages/ui) or [@tonconnect/sdk](https://github.com/ton-connect/sdk/tree/main/packages/sdk), or implement the protocol yourself if your product requires it.
:::
...
- Example of a DApp with `@tonconnect/ui-react`: [Demo](https://github.com/ton-connect/demo-dapp-with-react-ui)
- Example of deployed `demo-dapp-with-react-ui`: [Demo](https://ton-connect.github.io/demo-dapp-with-react-ui/)
...
Developers can easily integrate TON Connect with apps using simple UI elements, such as the _Connect Wallet button_, _Select Wallet dialogue_, and _confirmation modals_. Here are three related resources and examples for working with TON Connect:
...
The TON Connect SDK is the lowest level of the three packages that help developers integrate TON Connect into their applications. It primarily connects apps to wallets through the TON Connect protocol.
