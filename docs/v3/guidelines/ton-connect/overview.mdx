...
- **Transactions**. Create specified transaction messages using TON libraries. Dive into the process of [sending messages](/v3/guidelines/ton-connect/cookbook/ton-transfer) with our comprehensive guide.
