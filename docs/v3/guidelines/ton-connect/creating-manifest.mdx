...
<table className="manifest-table">
  ...
  <tr>
    <td><code>url</code></td>
    <td>Yes</td>
    <td>Defines the DApp’s base URL. It is used to open the app when a user taps its icon in the wallet. The URL should not include a trailing slash — for example, use <strong>https://mydapp.com</strong> instead of <strong>https://mydapp.com/</strong>.</td>
  </tr>
  ...
  <tr>
    ...
    <td>Yes</td>
    <td>Defines the URL to the app icon. Must be in **PNG** or **ICO** format. SVG is **not** supported. Ideally, use a **180x180px PNG**.</td>
  </tr>
