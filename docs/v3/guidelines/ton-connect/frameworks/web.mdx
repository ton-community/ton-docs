...
If you use React for your DApp, take a look at [TON Connect UI React SDK](/v3/guidelines/ton-connect/frameworks/react).

And if you use Vue for your DApp, take a look at [TON Connect UI Vue SDK](/v3/guidelines/ton-connect/frameworks/vue).
...
To redirect user to a [Telegram Mini App](/v3/guidelines/dapps/tma/overview) after wallet connection use `twaReturnUrl` option:
