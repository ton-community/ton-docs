...
See [how to create a `manifest.json`](/v3/guidelines/ton-connect/creating-manifest) for more details.
...
But you can open the **connect modal** programmatically, for example, after clicking on a custom button:
