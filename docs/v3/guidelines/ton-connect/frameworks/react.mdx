...
The recommended SDK for React apps is the [UI React SDK](/v3/guidelines/ton-connect/guidelines/developers#ton-connect-react). It provides a high-level React component to interact with TON Connect.
