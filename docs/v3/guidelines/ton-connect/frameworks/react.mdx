...
The [UI React SDK](/v3/guidelines/ton-connect/guidelines/developers#ton-connect-react) is the recommended option for React apps.
It provides a high-level React component to interact with TON Connect.
