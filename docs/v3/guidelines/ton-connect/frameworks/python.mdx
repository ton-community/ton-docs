...
The recommended SDK for Python applications is [tonutils](https://github.com/nessshon/tonutils).
...
try:
    ...
    print("Wallet does not support the sign data feature!")
...
- [`SendTransactionResponse`](https://github.com/nessshon/tonutils/blob/064a58f32c0c872feed37f49a6af7113268bbc7b/tonutils/tonconnect/models/request.py#L245)
- [`SignDataResponse`](https://github.com/nessshon/tonutils/blob/064a58f32c0c872feed37f49a6af7113268bbc7b/tonutils/tonconnect/models/request.py#L494)
