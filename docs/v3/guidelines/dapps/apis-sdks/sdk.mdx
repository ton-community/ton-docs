...
4. Off-chain only - These SDKs allow you to create and serialize cells, which can then be sent to APIs.
...
| Library |	Blockchain connection |	Description |
|---------|------------------|--------------|
|[tonutils-go](https://github.com/xssnick/tonutils-go)|Native ADNL|Go library for interacting with TON.|
...
|[tonlib-java](https://github.com/ton-blockchain/tonlib-java)	| Java                                                                                                | 	Tonlib binary	                                                                                         | JVM wrapper for Tonlib, usable with Java, Scala, Kotlin, etc.|
|[ayrat555/ton](https://github.com/ayrat555/ton) | Elixir                                                                                              | *off-chain only*                                                                                      | TON SDK for Elixir.|
...
|[labraburn/node-tonlib](https://github.com/labraburn/node-tonlib)| Node.js                                                                                              | Tonlib binary                                                                                        |C++ addon for NodeJS to work with tonlibjson.|
...
|[pytvm](https://github.com/yungwine/pytvm) | Python | *off-chain*                                                                                           | Python TVM emulator using C++ bindings. |
...
|[tonutils](https://github.com/thekiba/tonutils)| TypeScript | Native [ADNL](/v3/documentation/network/protocols/adnl/adnl-tcp)                                     | TypeScript-based interface for TON application development. Due to native ADNL dependency, it cannot be used in browsers.|
