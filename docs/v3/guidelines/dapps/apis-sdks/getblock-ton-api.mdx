...
Visit the GetBlock [website](https://getblock.io/) and click on the "Get Started for Free" button. Sign up using your email address or by connecting your MetaMask wallet.
...
Feel free to learn more at the [website](https://getblock.io/) or drop a line to GetBlock’s support via live chat, [Telegram](https://t.me/GetBlock_Support_Bot), or a website form.
