...
There are several ways to connect to the TON Blockchain:
...
4. Off-chain only – Some SDKs allow you to create and serialize cells, which you can then send to APIs.
