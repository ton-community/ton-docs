...
## Transactions fundamentals in TON {#transaction_terms}

Теория о транзакциях в контексте ТОНа
...
### Hashes for verifying on backend
...
### Hashes for verifying on frontend
...
### Verify transaction status using hash
...
### Fetch transaction by message hash
