...
- General account state - general properties of each account: ID, balance, status, last_tx properties
- Data - custom account state  
- Code - custom account logic  

General account state properties completely define all accounts in TON:
...
* (ID1, 0, unexist)
* (ID2, 2, inited, last_tx, data, code)
...
*external in* messages serve a similar function from the actor’s point of view.
