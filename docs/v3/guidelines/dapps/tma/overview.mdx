...
Mini Apps run directly in Telegram and are instantly accessible to its 900+ million users — without the need for installs or redirects.
...
- [Telegram Mini Apps documentation](https://docs.telegram-mini-apps.com) — community-driven documentation for TMA.
...
|------------|-------------|
| [twa-dev/sdk](https://github.com/twa-dev/sdk) | NPM package for the TWA SDK. |
| [twa-dev/boilerplate](https://github.com/twa-dev/Boilerplate) | a boilerplate for a new TWA |
| [twa-dev/Mark42](https://github.com/twa-dev/Mark42) | a simple, lightweight, tree-shakable UI library for TWA |
| [ton-defi-org/tonstarter-twa](https://github.com/ton-defi-org/tonstarter-twa) | a template for a new TWA interacting with TON |
