...
- Search for `@BotFather` in the search bar or click this link [https://t.me/protectronnews](https://t.me/protectronnews).
...
- Send the `/mybots` command to [@protectronnews](https://t.me/protectronnews).
