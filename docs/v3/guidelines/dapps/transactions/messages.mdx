...
* **Understand how messages drive computation in TON:** how messages act as the sole mechanism of interaction between smart contracts and what roles they play in triggering transactions.
* **Explore the structure and types of messages:** how external-in, internal, and external-out messages differ in origin, behavior, and use cases within the blockchain.
* **Learn how to compose and send messages:** how to construct messages using TL-B schemas, encode payloads, and interact with smart contracts using tools like Blueprint.
...
Все сообщения в TON are described using this schema
...
<Button href="/v3/guidelines/dapps/transactions/hashes" colorType={'primary'} sizeType={'sm'}>
