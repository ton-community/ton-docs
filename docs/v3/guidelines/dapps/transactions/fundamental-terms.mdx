...
# Foundations of transactions {#transaction_terms}

## What you'll learn

* **Learn how TON applies the actor model to structure computation:** how accounts and smart contracts operate as isolated actors, how they communicate through messages, how each message triggers a transaction, and why asynchronous execution is essential to the system’s design.
* **Understand how accounts and smart contracts are represented on-chain:** how accounts encapsulate code, data, and status; how their unique addresses are derived from the initialized state; and how their structure is defined using TL-B schemas.
* **How TON scales: from single-account chains to a blockchain of blockchains:** you’ll explore the multi-layered hierarchy of AccountChains, ShardChains, WorkChains, and the MasterChain.
...
![](/img/docs/blockchain-fundamentals/asynchrony.svg)
...
<Button href="/v3/guidelines/dapps/transactions/messages" colorType={'primary'} sizeType={'sm'}>
