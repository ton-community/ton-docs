...
# Getting started
Before diving into DApps, make sure you understand blockchain fundamentals. You may find our [The Open Network](/v3/concepts/dive-into-ton/introduction) and [Blockchain of blockchains](/v3/concepts/dive-into-ton/ton-blockchain/overview) articles useful.
...
- [Understanding Toncoin](/v3/documentation/dapps/assets/toncoin)
- [Tokens: jettons & NFTs](/v3/documentation/dapps/assets/jetton)
