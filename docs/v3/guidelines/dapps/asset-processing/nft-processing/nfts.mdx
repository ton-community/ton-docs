...
- Verify all new transactions and ignore those with a body length less than 363 bits (OP - 32, `query_id` - 64, Address - 267; [internal addresses are 267 bits](/v3/documentation/smart-contracts/tolk/tolk-vs-func/in-detail#type-address)).
