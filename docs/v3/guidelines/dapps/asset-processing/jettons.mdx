...
- Refer to the official JS library from TON Foundation, [tonweb](https://github.com/toncenter/tonweb), for a JS lib example.
...
To prevent fraud, verify the **original jetton address** (jetton master contract) for specific jetton types. Alternatively, **check the project's official social media channels** or website for **accurate information**. Use [Tonkeeper ton-assets list](https://github.com/tonkeeper/ton-assets) ton-assets list to verify assets.
...
| `amount`               | coins      | The total `ton coin` amount sent with the message.                                                                                                                    |
...
This transfer requires some ton coins for **fees** and **transfer notification message**.
