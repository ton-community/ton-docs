...
Wallet smart contracts on TON Blockchain allow external actors to interact with the blockchain entities. They serve the following purposes:
  ...
  <TabItem value="GO" label="tonutils-go">
    ...
    func main() {
      if _, err := address.ParseAddr("EQCD39VS5j...HUn4bpAOg8xqB2N"); err != nil {
        fmt.Println(errors.New("invalid address"))
        return
  }
