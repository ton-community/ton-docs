...
## Next Steps:
 ...
 - Continue to [Interact with blockchain](/v3/guidelines/quick-start/blockchain-interaction/reading-from-netowrk) if you want to learn how to interact with `smart-contracts` from outside the blockchain.
