...
:::note
We will provide a short explanation of core concepts during the guide, but if you prefer a more theoretical approach, check out the core concepts of [TON Blockchain](/v3/concepts/dive-into-ton/ton-blockchain/blockchain-of-blockchains) first.
:::
...
First, let's examine the common [address states](/v3/documentation/smart-contracts/addresses/address-states) of our smart contract:
