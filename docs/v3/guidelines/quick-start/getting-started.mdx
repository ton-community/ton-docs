...
:::note
We will provide a short explanation of core concepts during the guide, but if you prefer a more theoretical approach, you can check out the core concepts of [TON Blockchain](/v3/concepts/dive-into-ton/ton-blockchain/overview) first.
:::
...
Transactions in TON always require some funds, as executing smart contract code requires paying a [fee](/v3/documentation/smart-contracts/transaction-fees/fees). TON basic transactions are very cheap—about 1 cent per transaction. Getting the equivalent of $5 worth of [Toncoin](/v3/documentation/dapps/assets/toncoin) will be enough for hundreds of them. Here’s how you can get them:

TON basic transactions are very cheap—about 1 cent per transaction. Getting the equivalent of $5 worth of [Toncoin](/v3/documentation/dapps/assets/toncoin) will be enough for hundreds of them. Here’s how you can get them:
