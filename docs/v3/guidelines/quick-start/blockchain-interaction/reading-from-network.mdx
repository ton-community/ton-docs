...
async function main() {
  ...
  const transactions = await tonClient.getTransactions(
    // Your Testnet address to fetch transactions
    Address.parse('your Testnet wallet address'),
    {
...
* Replace `your Testnet wallet address` with your Testnet address from Tonviewer.
...
```bash
Timestamp: 1748381530
Value: 2000000000n
Sender: EQCSES0TZYqcVkgoguhIb8iMEo4cvaEwmIrU5qbQgnN8fmvP
```
