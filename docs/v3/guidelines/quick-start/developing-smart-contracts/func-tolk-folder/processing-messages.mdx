...
Since TON implements the [actor](/v3/guidelines/dapps/transactions/foundations-of-blockchain#actor) model, it's natural to think about smart contract relations in terms of `roles`, determining who can access smart contract functionality or not. The most common examples of roles are:
