...
**Congratulations!** Your custom smart contract is ready to execute get methods the same way as your wallet in the [Getting started](/v3/guidelines/quick-start/getting-started) section and execute transactions the same as in the [Writing to network](/v3/guidelines/quick-start/blockchain-interaction/writing-to-network) section — consider reading it to understand how to interact with smart contracts off-chain if you haven't already.
