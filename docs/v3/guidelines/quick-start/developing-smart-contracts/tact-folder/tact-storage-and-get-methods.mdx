...
A contract may store its state variables as follows. They may be accessed with the [`self` reference](https://docs.tact-lang.org/book/contracts/#self)
...
For messages with an empty body, you can add a `receive` function with no arguments:
