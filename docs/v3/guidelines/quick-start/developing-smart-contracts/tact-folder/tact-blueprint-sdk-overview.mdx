...
For questions, support, or discussion about the Tact language, join the official Telegram chat: [@tactlang](https://t.me/tactlang). The community and core developers are active and happy to help!
:::
