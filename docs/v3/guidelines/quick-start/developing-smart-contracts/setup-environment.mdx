...
This guide covers basic steps of creating your first TON smart-contract using availible languages: `FunC`, `Tact`, `Tolk`.

But before we proceed to actual coding lets install and setup all required tools!

## Prerequsites

 - Basic programming skills.
 - Familiarity with Command-line inteface.
 - You preferred code-editor/IDE.
...
Change directory for parent folder of you future project and run folowing command:
...
This will run interactive script for creating project template, you can enter anything you want, but if you want to have same paths as this guide choose folowing:
...
And finally, change you current directory to generated project template folder, and install all required dependencies:
...
Also consider installing plugins providing support for JavaScript/TypeScrypt tools for yor preferred IDE or code editor and, specificly, `Jest` for debugging smart-contract tests.
