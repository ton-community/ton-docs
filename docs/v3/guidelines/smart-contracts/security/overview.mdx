...
- [TON smart contract security best practices](/v3/guidelines/smart-contracts/security/common-vulnerabilities/) - Critical security pitfalls and how to avoid them
- [Secure smart contract programming](/v3/guidelines/smart-contracts/security/secure-programming/) - Best practices for secure smart contract development
- [Things to focus on while working with TON Blockchain](/v3/guidelines/smart-contracts/security/things-to-focus/) - Key considerations for TON development
