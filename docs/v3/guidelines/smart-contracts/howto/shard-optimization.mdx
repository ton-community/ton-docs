...
From the human perspective, the easiest way to check the address shard is to look at the address [raw form](/v3/concepts/dive-into-ton/ton-blockchain/addresses#raw-address).
