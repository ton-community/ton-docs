...
In this case, the address distribution is random, and all data fields are meaningful, making it non-tunable.
However, nothing stops us from modifying it like this:
