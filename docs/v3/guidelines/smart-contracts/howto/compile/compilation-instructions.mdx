...
>>>>>>> pitaya/doc-fix/run_20250901_144329_2bdedc55/kf7c316e8



:::tip
<<<<<<< HEAD
If you are compiling on a computer with low memory (e.g., 1 GB), don't forget to [create a swap partition](/v3/guidelines/smart-contracts/howto/compile/instructions-low-memory).
=======
...
<<<<<<< HEAD
For tools like the Lite Client you need to download the global network config.
=======
