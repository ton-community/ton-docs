...
1. Set up the hardware for the validator — you will need 16 cores CPU, 128 GB RAM, 1 TB NVMe SSD (or ≥64k IOPS), 1 Gbit/s network connectivity, Public IP.
   ...
   > **Recommended providers include:** [AWS](https://aws.amazon.com/), [DigitalOcean](https://www.digitalocean.com/), [Linode](https://www.linode.com/), [Alibaba Cloud](https://alibabacloud.com/), [Latitude](https://www.latitude.sh/).
