...
:::info
This guide provides basic information. For further details, please refer to our TL-B [documentation](/v3/documentation/data-formats/tlb/overviewe) to learn more about TL-B.
:::
...
:::tip TL-B
You can read more about TL-B [here](/v3/documentation/data-formats/tlb/overviewe).
:::
...
- [TL-B](/v3/documentation/data-formats/tlb/overviewe)
