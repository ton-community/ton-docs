...
:::info opcodes
For a comprehensive list of TVM opcodes, including those mentioned below, refer to [TVM instructions](/v3/documentation/tvm/instructions).
:::
