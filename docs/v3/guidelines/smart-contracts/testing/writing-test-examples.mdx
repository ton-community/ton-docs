...
A library is a cell stored in [MasterChain](/v3/concepts/dive-into-ton/ton-blockchain/overview#masterchain-blockchain-of-blockchains) and can be used by all smart contracts if it is [public](https://github.com/ton-blockchain/ton/blob/9728bc65b75defe4f9dcaaea0f62a22f198abe96/crypto/block/transaction.cpp#L1844).
