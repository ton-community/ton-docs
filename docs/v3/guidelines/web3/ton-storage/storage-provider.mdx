...
:::info
If the storage contract is closed, the client receives a message with the remaining balance and [`op=0xb6236d63`](https://github.com/ton-blockchain/ton/blob/master/storage/storage-daemon/smartcont/constants.fc#L7).
:::
