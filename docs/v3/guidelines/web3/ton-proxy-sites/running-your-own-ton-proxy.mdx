...
4. Generate a persistent ADNL address for your entry proxy.
   ...
   This is your newly generated persistent ADNL address in hexadecimal and user-friendly form. The corresponding private key is saved into file `45061...2BD` in the current directory. Move the key into the keyring directory.
