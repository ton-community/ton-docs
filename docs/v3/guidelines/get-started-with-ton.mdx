...
2. Next, you need to [enable test mode](/v3/concepts/dive-into-ton/ton-ecosystem/wallet-apps#wallets-for-everyday-users) within Tonkeeper.
...
In this guide, you'll need to run TypeScript scripts. All commands, such as running scripts or installing modules, are executed through the command line located in the IDE's Terminal workspace, which is typically found at the bottom of the IDE.
