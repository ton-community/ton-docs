...
1. Read [typography guidelines](/v3/contribute/typography)
1. Take inspiration from the [Mint your first Jetton](/v3/guidelines/dapps/tutorials/mint-your-first-token) article.
1. **Setup environment**. [Check the tutorial](/v3/contribute) running your fork locally or using Gitpod.
1. **Write tutorial**. Using the environment, see how tutorial looks like on your fork.
1. **Make a Pull Request**. Open PR to get some feedback from maintainers.
1. Get merged!
