# ton.docs.org style guide

Content on is crowdsourced and originally written by TON [contributors](docs/v3/contribute/maintainers) and support by [TON Studio](https://tonstudio.io/).
...
You should read this style guide before you [contributing](docs/v3/contribute).
...
[Content standardization](docs/v3/contribute/content-standardization/) - Read more about proper usage of terminology and other aspects such as how to properly add an image, attribute etc.
[Typography](docs/v3/contribute/content-standardization/) - Read best practice on plain text and headers.
