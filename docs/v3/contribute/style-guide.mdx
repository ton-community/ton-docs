...
[**Documentation**](/v3/documentation/introduction/) for **TON developers:**
...
### Guidelines for external developers
  ...
  **Example external developer journeys**:
  ...
  - “I’ve started working on integrating my project with TON and want to figure out how to do this best.”
...
### Documentation for TON developers
  ...
  **Example TON developer journeys**:
  ...
  - “I want to develop industrial-grade smart contracts for TON Ecosystem according to best practices and specifications.”
  ...
  - “I want to upgrade TON specifications to enhance the developer experience.”
...
- Articles are hard to digest due to dense, unstructured content
...
#### Concepts and guidelines best practices
...
- Limit an article’s length to 2,000 words
- Reduce the number of hyperlinks to approximately 10 per 2,000 words
- Write for readers who have just started and are curious about blockchain technology
...
For documentation readers, this is a list of typical content issues.
...
- Only code is provided, without explanation or documentation

Make documentation content great for its audience with the following rules.

#### Documentation best practices
- Provide updates to the documentation as soon as changes occur.
...
- Apply style updates and proofread
...
#### Guidelines
- Add step-by-step instructions on how to take action
- Include relevant statistics or graphs to strengthen the arguments
- Add calls to action

#### Documentation
- Update or improve existing documentation.
- Add comprehensive new documentation about TON components: nodes, oracles, smart contracts, and TVM internals.
...
- [Content standardization](/v3/contribute/content-standardization/) - Learn how to organize content, add images, attributes, etc., correctly.
- [Typography](/v3/contribute/typography/) - Learn the best practices for plain text and headers.
