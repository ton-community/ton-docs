...
This documentation provides best practices and technical insights for developing industrial-grade smart contracts and global market applications. It is also a manual for those planning to improve blockchain software and upgrade TON protocols. The documentation section focuses on enhancing developer experiences through deep, detailed documentation.
...
- [Content standardization](/v3/contribute/content-standardization/) - Read more about proper usage of terminology and other aspects, such as how to add an image, attribute, etc, correctly.
