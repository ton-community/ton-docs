...
- Learn the documentation development flow from a [ton-docs/README.mdx](https://github.com/ton-community/ton-docs?tab=readme-ov-file#set-up-your-environment-%EF%B8%8F) document.
