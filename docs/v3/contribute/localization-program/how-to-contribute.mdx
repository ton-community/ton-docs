...
3. Familiarize yourself with the [How it works](/v3/contribute/localization-program/how-it-works/) guide and the [Translation style guide](/v3/contribute/localization-program/translation-style-guide/) for tips and best practices.
...
3. Create a PR to the dev branch. **Do not merge into dev**; this is for preview purposes only.
