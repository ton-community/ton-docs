...
3. Familiarize yourself with the [Crowdin online editor guide](https://support.crowdin.com/online-editor/) and the [Translation style guide](/v3/contribute/localization-program/translation-style-guide) for tips and best practices.
...
- **Update footer configuration for your language:**
  ...
  4. Translate the values of the keys **`headerLangKey`** and **`langKey`** to your language, as we did for Chinese (Simplified) in **`FOOTER_COLUMN_LINKS_CN`**.
...
2. Open an issue in this repository requesting the language be added to the site menu.
