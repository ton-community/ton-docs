...
After these steps you are ready to contribute and receive [Limited Hack-TON-berfest NFT](/contribute/hacktoberfest/#what-the-rewards).

Welcome to the club, this is just the beginning!

## New to contributing to open source?

Hacktoberfest is a great place to start dipping your toes into open source contributions for the first time. There are plenty of streams, posts, guides, and discussions about getting started. You’ll be joining many folks also starting their journey this month!

* [Hacktoberfest main information for beginners](https://hacktoberfest.com/participation/#beginner-resources)
