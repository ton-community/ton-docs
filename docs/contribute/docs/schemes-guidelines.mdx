...
|![](/img/docs/scheme-templates/message-processing-graphs/line_for_msg.svg?raw=true) | Arrow - Message with description |
|![](/img/docs/scheme-templates/message-processing-graphs/dashed_line_for_transaction.svg?raw=true) | Dashed Arrow - Optional Message Entity |
...
<ThemedImage
  alt=""
  sources={{
    light: '/img/docs/message-delivery/message_delivery_8.svg?raw=true',
    dark: '/img/docs/message-delivery/message_delivery_8.svg?raw=true',
  }}
/>
<br></br>
