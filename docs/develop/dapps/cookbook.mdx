...
```sh
dart pub get tonutils
```

```dart
import 'package:tonutils/tonutils.dart' show InternalAddress;

  InternalAddress address1 =
      InternalAddress.parse('EQDKbjIcfM6ezt8KjKJJLshZJJSqX7XOA4ff-W72r5gqPrHF');
  InternalAddress address2 = InternalAddress.parse(
      '0:ca6e321c7cce9ecedf0a8ca2492ec8592494aa5fb5ce0387dff96ef6af982a3e');

  // user friendly
  print(address1.toString(
    isBounceable: true,
    isUrlSafe: true,
  ...
  // HEX
  print(
    address2.toRawString(),
  ); // 0:ca6e321c7cce9ecedf0a8ca2492ec8592494aa5fb5ce0387dff96ef6af982a3e

  const bool IS_TESTNET_ONLY = true;
  // user friendly
  print(address1.toString(
    isBounceable: true,
    isUrlSafe: true,
    isTestOnly: IS_TESTNET_ONLY,
