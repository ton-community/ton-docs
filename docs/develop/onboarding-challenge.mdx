...
3. You added to the `collection` address of the [NFT collection from _mainnet_](https://getgems.io/collection/EQDk8N7xM5D669LC2YACrseBJtDyFqwtSPCNhRWXU7kjEptX)

4. You __changed API provider__ URL to the _mainnet_ (just remove `testnet.` subdomain) and obtained the [API key](/develop/dapps/apis/toncenter#get-api-key)
