...
You are one of the first explorers here. If you find any mistakes or feel stacked, please send feedback to [@SwiftAdviser](https://t.me/SwiftAdviser). I will fix it asap (_after holidays_).
:::
...
Impressed? It's possible to make a miner in __one evening__, just stay focussed.
...
1. __Smart contracts__. [TON Hello World: Step-by-step guide for your first smart contract](https://blog.ton.org/step-by-step-guide-for-writing-your-first-smart-contract-in-func)
