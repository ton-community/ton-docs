...
Welcome aboard! 🛳 You came here to become a true **TVM Developer** on the most advanced asynchronous blockchain in the world, The Open Network (TON).
...
_You're going to mine an NFT rocket!!!_
...
Impressed? It's possible to make a miner in __30 minutes__, just stay focussed.
...
2. Enable test mode in Tonkeeper by tapping the version 5 times in the settings.

<ConceptImage src="/img/tutorials/tonkeeper/test-mode.webp" />
...
Before we cover environment setup, you should know: _it's possible to complete the TON Onboarding Challenge completely in the cloud! It's free and quick._
