...
Using the `ton.js`, we’ll execute a series of code using _TonClient_ and _getHttpEndpoint_:
...
* [Simple: NFT Testnet Mining](/develop/onboarding-challenge#simple-mine-in-testnet)
* [Genuine: NFT Mainnet Mining](/develop/onboarding-challenge#genuine-mine-in-mainnet)

### Simple: NFT Testnet Mining

Below are the steps needed to initiate your first Testnet transaction to mine your NFT:

1. Activate [Testnet mode within your Tonkeeper walle](/participate/wallets/apps#tonkeeper-test-environment)
