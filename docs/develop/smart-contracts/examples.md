...
| [ton-forwarder.fc](https://github.com/TrueCarry/ton-contract-forwarder/blob/main/func/ton-forwarder.fc) <br /> <small>🪄 [Run in WebIDE](https://ide.nujan.io/?importURL=https://github.com/TrueCarry/ton-contract-forwarder/blob/main/func/ton-forwarder.fc&name=ton-forwarder.fc)</small>         | Contract that accepts exact sum and forwards it to specified address. On wrong amount or subsequent returns money. |
