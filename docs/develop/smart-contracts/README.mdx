...
Write and deploy your first smart contract with Blueprint(JS) and Toncli frameworks.

### Blueprint

Blueprint — is a development environment for TON blockchain for writing, testing, and deploying smart contracts.
To create a new demo project and follow the on-screen instructions, run the following code in the terminal:

```console
npm create ton@latest
```

Follow process with video tutorial [How to write and deploy Smart Contract in FunC with Blueprint?](https://www.youtube.com/watch?v=isfFGmyJvns&list=PLyDBPwv9EPsA5vcUM2vzjQOomf264IdUZ)

Learn more in the [Blue Print](/develop/smart-contracts/sdk/javascript) section
...
Learn more in the [Toncli](/develop/smart-contracts/sdk/toncli) section.
