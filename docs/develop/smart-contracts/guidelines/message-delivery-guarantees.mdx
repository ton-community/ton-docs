...
And the most complicated example is shown in the image below. In this case, we also can't say which message will be delivered to _B_ first. Yes, the chances of message _2_ being faster than _6_ are obviously higher, but still not 100%.
