...
- the incoming message that initially triggers the contract
- contract actions caused by in message, such as an update to the contract's storage
- outgoing generated messages that are sent to other actors
