...
Currently, the library is just a wrapper for the most common assembler of the TVM commands which aren't built-ins. Each TVM command description used in the library can be found in the [TVM documentation](https://ton.org/tvm.pdf) (appendix A). Some descriptions were borrowed for this document.
