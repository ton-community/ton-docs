...
To build FunC compiler from source code do [common part](/docs/develop
...
To build Fift compiler from source code do [common part](/docs/develop/compile.md#Common) described above and then:
