...
// footer links
const PAGE_TON_COIN = "/toncoin";
const PAGE_STAKE = "/stake";
const PAGE_VALIDATOR = "/validator";
const PAGE_MINING = "/mining";
const PAGE_COMMUNITY = "/community";
const PAGE_ROADMAP = "/roadmap";
const PAGE_ANALYSIS = "/analysis";
const PAGE_BRAND_ASSETS = "/brand-assets";
const PAGE_GRANTS = "/grants";
const PAGE_BUY_TONCOIN = "/buy-toncoin";
const PAGE_EVENTS = "/events";
const PAGE_WALLETS = "/wallets";
const PAGE_DEV = "/dev";
const PAGE_CONTACT_US = "/contact-us";
const PAGE_COLLABORATE = "/collaborate";
const PAGE_LIQUIDITY_PROGRAM = "/defi-liquidity-program";
...
const TON_OVERFLOW_URL = "https://answers.ton.org";
