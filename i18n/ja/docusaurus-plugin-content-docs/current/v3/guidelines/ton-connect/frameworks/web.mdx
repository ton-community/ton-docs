...
TonConnect UIは、さまざまなアプリを使用するときに使い慣れた、認識できるインターフェイスを提供します。 ただし、アプリ開発者はこのインターフェイスを変更して、アプリのインターフェイスと一貫性を保つことができます。 However, the app developer can modify this interface to keep it consistent with the app's interface.
