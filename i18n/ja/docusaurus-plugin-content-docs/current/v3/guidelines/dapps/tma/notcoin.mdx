...
- [Notcoinテレグラムミニアプリ](https://t.me/notcoin_bot/click)
- [GitHubチーム](https://github.com/OpenBuilders)
- [Notcoinクリッカーフロントエンド](https://github.com/OpenBuilders/notcoin-clicker)
- [Notcoinスマートコントラクト](https://github.com/OpenBuilders/notcoin-contract)
