...
1. Open Wallets list.
2. Return to the main menu and create a new Testnet wallet: Add wallet → Add Testnet Account.
  :::
...
Great! 素晴らしい！これでプロジェクトのコードを書き始める準備ができた。
...
| 記述       | NFT description. NFTの説明推奨される長さ：500文字以内                                                                                                                                |
