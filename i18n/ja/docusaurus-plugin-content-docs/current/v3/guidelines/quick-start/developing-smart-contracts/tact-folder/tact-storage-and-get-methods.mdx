...
Tact automatically serializes and deserializes messages into cells.</summary>
...
After building your contract, Tact automatically generates a special wrapper file. [Wrappers](https://docs.tact-lang.org/book/compile/#wrap-ts) facilitate contract interaction from TypeScript.
