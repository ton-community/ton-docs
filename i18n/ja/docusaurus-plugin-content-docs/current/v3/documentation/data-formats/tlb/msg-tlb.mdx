...
| 情報        | [CommonMsgInfo](#commonmsginfo) | Required | Contains detailed message properties such as destination and value. It is always stored in the message's root cell.             |   |
...
| create_at       | uint32                                    | Required | UNIX timestamp indicating when the message was created.                                                                         |
...
| create_at           | uint32                               | Required | UNIX timestamp representing when the message was created.                                                                       |
...
| その他          | ExtraCurrencyCollection | Optional | ExtraCurrencyCollection is a dictionary intended for additional, typically empty currencies.                                        |
