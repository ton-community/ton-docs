...
Here is a [link to the original article](https://github.com/xssnick/ton-deep-doc/blob/master/ADNL-TCP-Liteserver.mdx) - _[Oleg Baranov](https://github.com/xssnick)_.
