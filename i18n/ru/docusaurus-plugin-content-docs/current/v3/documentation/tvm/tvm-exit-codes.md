...
The following table lists exit codes with an origin (where it can occur) and a short description. The table doesn't list the exit codes from contracts. Альтернативные коды выхода следует искать в исходном коде соответствующего контракта.

| Код выхода      | Origin                                 | Описание                                                                                                                                 |
| :-------------- | :------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------- |
| `0`             | [Compute][c] and [action][a] phases    | Стандартный код выхода при успешном выполнении.                                                                          |
| `1`             | [Compute phase][c]                     | Альтернативный код выхода при успешном выполнении. Reserved, but doesn't occur.                          |
| `2`             | [Compute phase][c]                     | Stack underflow.                                                                                                         |
| `3`             | [Compute phase][c]                     | Stack overflow.                                                                                                          |
| `4`             | [Compute phase][c]                     | Integer overflow.                                                                                                        |
| `5`             | [Compute phase][c]                     | Целое число выходит за пределы ожидаемого диапазона.                                                                     |
| `6`             | [Compute phase][c]                     | Invalid [TVM][tvm] opcode.                                                                                                               |
| `7`             | [Compute phase][c]                     | Ошибка проверки типа.                                                                                                    |
| `8`             | [Compute phase][c]                     | Cell overflow.                                                                                                           |
| `9`             | [Compute phase][c]                     | Cell underflow.                                                                                                          |
| `10`            | [Compute phase][c]                     | Ошибка словаря.                                                                                                          |
| `11`            | [Compute phase][c]                     | В [документации TVM](https://ton.org/tvm.pdf) это описывается как "Неизвестная ошибка, может быть выдана пользовательскими программами". |
| `12`            | [Compute phase][c]                     | Fatal error thrown by [TVM][tvm] in unexpected situations                                                                                |
| `13`            | [Compute phase][c]                     | Ошибка отсутствия газа.                                                                                                  |
| `-14`           | [Compute phase][c]                     | Equivalent to code 13. A negative value prevents [imitation](#13)                                                        |
| Фаза действий   | [Compute phase][c]                     | VM virtualization error (reserved but unused)                                                                         |
| `32`            | [Action phase][a]                      | Фаза действий                                                                                                                            |
| `33`            | [Action phase][a]                      | Список действий слишком длинный.                                                                                         |
| `34`            | [Action phase][a]                      | Действие недопустимо или не поддерживается.                                                                              |
| `35`            | [Action phase][a]                      | Недопустимый исходный адрес в исходящем сообщении.                                                                       |
| `36`            | [Action phase][a]                      | Недопустимый адрес назначения в исходящем сообщении.                                                                     |
| `-32`           | [Action phase][a]                      | Недостаточно TON.                                                                                                        |
| `38`            | [Action phase][a]                      | Недостаточно дополнительных валют.                                                                                       |
| `37`            | [Action phase][a]                      | Outbound message does not fit into a cell after rewriting.                                                               |
| `40`            | [Action phase][a]                      | Cannot process a message — not enough funds, the message is too large, or its Merkle depth is too big.                   |
| Фаза вычислений | [Action phase][a]                      | Library reference is null during library change action.                                                                  |
| Фаза вычислений | [Action phase][a]                      | Library change action error.                                                                                             |
| `43`            | [Action phase][a]                      | Превышено максимальное количество ячеек в библиотеке или превышена максимальная глубина дерева Меркла.                   |
| Фаза вычислений | [Action phase][a]                      | Account state size exceeded limits.                                                                                      |
| Фаза вычислений | Tact compiler ([Compute phase][c])     | Null reference exception. Configurable since Tact 1.6.                                   |
...
| Фаза вычислений | Tact compiler ([Compute phase][c])     | Access denied — someone other than the owner sent a message to the contract.                                             |
| Фаза вычислений | Tact compiler ([Compute phase][c])     | Contract stopped. Reserved, but never thrown.                                                            |
| Фаза вычислений | Tact compiler ([Compute phase][c])     | Invalid argument.                                                                                                        |
...
Fatal error. Выдается TVM в ситуациях, которые считаются невозможными.
...
### Список действий недействителен.
