...
| `RIST255_QVALIDATE` | _`x - 0 или -1`_       | Quiet version of `RIST255_VALIDATE`.<br/>_234 gas_.                                                                     |
| `RIST255_QADD`      | _`x y - 0 или x+y -1`_ | Quiet version of `RIST255_ADD`. <br/>_634 gas_.                                                                         |
| `RIST255_QSUB`      | _`x y - 0 или x-y -1`_ | Quiet version of `RIST255_SUB`.<br/>_634 gas_.                                                                          |
| `RIST255_QMUL`      | _`x n - 0 или x*n -1`_ | Quiet version of `RIST255_MUL`.<br/>_2034 gas_.                                                                         |
| `RIST255_QMULBASE`  | _`n - 0 или g*n -1`_   | Quiet version of `RIST255_MULBASE`.<br/>_784 gas_.                                                                      |
