...
Эта документация создаётся совместно с сообществом, исходный код проекта открыт. Мы всегда рады новым участникам. Всю документацию можно редактировать на GitHub. Инструкция и формат работы представлены по [ссылке](/v3/contribute).
...
- _Начните работу с TON_ — пошаговое руководство по работе с блокчейном TON, у которого есть видеовариант.
