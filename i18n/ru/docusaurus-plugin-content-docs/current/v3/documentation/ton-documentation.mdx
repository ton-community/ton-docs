...
Добро пожаловать в официальную документацию TON Blockchain по разработке!

Здесь вы найдете всю необходимую информацию для разработки, тестирования и развёртывания приложений на блокчейне TON.

This is a collaborative, open-source initiative, and **contributions are always welcome**. Всю документацию можно редактировать на GitHub. Инструкция и формат работы представлены по [ссылке](/v3/contribute).
...
* *Начните работу с TON* — пошаговое руководство по работе с блокчейном TON, у которого есть видеовариант.

<Button href="https://helloworld.tonstudio.io/01-wallet/" colorType="primary" sizeType={'sm'}>
  TON Hello World
</Button>
...
Мы рады представить **курс по блокчейну TON** — полное, практическое руководство для разработчиков. Мы рады представить **курс по блокчейну TON** — полное руководство для разработчиков, желающих научиться создавать смарт-контракты и децентрализованные приложения на TON. Курс разработан в интерактивном формате, чтобы обучение было максимально увлекательным и полезным.
Он состоит из **9 модулей** и охватывает:

* The basics of the TON Blockchain
* Язык программирования FunC
...
Смарт-контракты — это строительные блоки децентрализованных приложений (DApps) на блокчейне TON.
Если вы хотите разрабатывать собственные DApps, вам важно понимать, как работают смарт-контракты.

<Button href="/v3/documentation/smart-contracts/overview" colorType="primary" sizeType={'sm'}>
  Getting started
</Button>
...
* [TON Hello World: пошаговое руководство по написанию вашего первого смарт-контракта](https://helloworld.tonstudio.io/02-contract/). Доступное и краткое объяснение основ работы с JavaScript.
...
Децентрализованные приложения (DApps) — это приложения, которые работают в одноранговой сети компьютеров (например, в блокчейне TON), а не на одном сервере.
Они напоминают традиционные веб-приложения, но функционируют на базе блокчейна. Это означает, что DApps децентрализованы, то есть не контролируются какой-либо одной организацией.
...
Изучите ключевые инструменты и концепции для создания децентрализованных финансовых приложений (DeFi) на блокчейне TON:
...
Сделайте первые шаги в создании децентрализованных приложений с этим подробным руководством:
