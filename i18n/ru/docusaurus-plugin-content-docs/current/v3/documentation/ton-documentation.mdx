...
- [TON Hello World: пошаговое руководство по написанию вашего первого смарт-контракта](https://helloworld.tonstudio.io/tutorials/02-contract/) — доступное и краткое объяснение основ работы с JS
...
- [TON Hello World: пошаговое руководство по созданию вашего первого веб-клиента](https://helloworld.tonstudio.io/tutorials/03-client/)
