...
>
> ["Cell" в документации](/v3/concepts/dive-into-ton/ton-blockchain/cells)
>
...
>
> ["Коды выхода" в документации](/v3/documentation/tvm/exit-codes)
...
[Стандартные коды исключений tvm](/v3/documentation/tvm/exit-codes)
...
> 💡 Примечание
>
> В этом примере мы используем `workchain()` для получения идентификатора воркчейна. Подробнее о идентификаторе воркчейна можно узнать в [документации](/v3/documentation/smart-contracts/addresses/address#workchain-id).
