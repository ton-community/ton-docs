...
```mdx-code-block
<Button href="https://blog.ton.org/introduction-to-fift" colorType="primary" sizeType={"sm"}>Introduction To Fift</Button>
```

```mdx-code-block
<Button href="https://blog.ton.org/introduction-to-fift" colorType="primary" sizeType={"sm"}>His majesty Fift</Button>
```
