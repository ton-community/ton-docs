...
###
 <h3 className="cmp-func-tolk-header"> ✅ Новый синтаксис функций: ключевое слово `fun`, атрибуты `@`, типы справа (как в TypeScript, Kotlin, Python и т. д.)</h3>
...
<table className="cmp-func-tolk-table">
  ...
  <tr>
    ...
    <td><code dangerouslySetInnerHTML={{__html: 'fun cons&amp;amp;amp;amp;lt;X&amp;amp;amp;amp;gt;(head: X, tail: tuple): tuple'}}></code></td>
  </tr>
  </tbody>
</table>
