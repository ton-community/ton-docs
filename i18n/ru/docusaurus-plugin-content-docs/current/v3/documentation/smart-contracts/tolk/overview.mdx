...
**Tolk** — это новый язык для написания смарт-контрактов в TON.
Компилятор Tolk — это буквально ответвление компилятора FunC, представляющее знакомый синтаксис, похожий на TypeScript, но оставляющее все низкоуровневые оптимизации нетронутыми. Представьте себе Tolk как «**следующее поколение FunC**».
