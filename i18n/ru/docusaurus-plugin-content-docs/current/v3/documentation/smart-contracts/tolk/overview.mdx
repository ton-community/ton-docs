...
2. [Настройте](https://ton.org/v3/documentation/smart-contracts/tolk/environment-setup.mdx) свой первый проект счётчика на Tolk с помощью команды `npm create ton@latest`.
