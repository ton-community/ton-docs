...
| `vesting_sender_address`                                                                           | Authorized address for locked funds management                                            | Параметры вестинга не изменяются и устанавливаются во время развертывания.         |
| `owner_address`                                                                                    | Beneficiary address for Toncoin distribution                                              | Пополнение                                                                         |
