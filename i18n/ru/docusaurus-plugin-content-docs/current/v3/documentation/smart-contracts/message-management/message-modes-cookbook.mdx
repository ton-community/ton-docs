...
| import_fee (скрыто)                                                                                           | 0,0006512      | cost of import of in_ext_msg                |
...
<br></br>
<div class="text--center">
  <ThemedImage alt="" sources={{light: "/img/docs/message-modes-cookbook/carry_remaining_value_11_noerror.png?raw=true",dark: "/img/docs/message-modes-cookbook/carry_remaining_value_11_noerror_dark.png?raw=true"}}  />
</div>
<br></br>
```
