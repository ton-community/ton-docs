...
[total_action_fees]: <Существует два способа оплаты действий в блокчейне:>
[`send_raw_message(msg, 0)`]: <[cb]: <Из [баланса контракта](https://github.com/ton-blockchain/ton/blob/7151ff26279fef6dcfa1f47fc0c5b63677ae2458/crypto/block/block.tlb#L263C1-L265C20)>
[msg]: <Из [значения сообщения](/v3/documentation/data-formats/tlb/msg-tlb#commonmsginfo)>
