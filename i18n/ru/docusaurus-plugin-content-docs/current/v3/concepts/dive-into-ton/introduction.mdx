...
**The Open Network (TON)** — это децентрализованная и открытая интернет-платформа, состоящая из нескольких компонентов. К ним относятся TON Blockchain, TON DNS, TON Storage, TON Sites и TON Proxy. Блокчейн TON — это основной протокол, который объединяет базовую инфраструктуру TON в единую экосистему TON.
...
Чтобы понять видение децентрализованный интернет и вклад TON в это неизбежное развитие, рекомендуем посмотреть следующее видео:
...
Подробное руководство по блокчейну TON. Курс предназначен для разработчиков, которые хотят научиться создавать смарт-контракты и децентрализованные приложения на блокчейне TON.
...
Для тех, кто уже знаком с разработкой на Ethereum, мы предлагаем вводные статьи, чтобы помочь вам понять ключевые преимущества и основные отличия TON от Ethereum:
