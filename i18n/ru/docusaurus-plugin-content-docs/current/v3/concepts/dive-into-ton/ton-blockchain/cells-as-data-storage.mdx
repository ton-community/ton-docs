...
В TON, весь блокчейн состоит из **ячеек** (cell). Ячейка — это структура данных, содержащая:
...
Таким образом, все ячейки формируют направленный ациклический граф (DAG), наглядная иллюстрация предоставлена ниже: Here's a good picture to illustrate: Here's a good picture to illustrate: Here's a good picture to illustrate: Here's a good picture to illustrate: Here's a good picture to illustrate: Here's a good picture to illustrate: Here's a good picture to illustrate: Here's a good picture to illustrate: Here's a good picture to illustrate: Here's a good picture to illustrate: Here's a good picture to illustrate: Here's a good picture to illustrate:
...
В настоящее время существует 5 типов ячеек: *обычные* и 4 *экзотических*.
...
Процесс сериализации описывается схемой TL-B. Это формальное описание того, как этот объект может быть сериализован в *Builder* или как проанализировать объект заданного типа из *Slice*.
