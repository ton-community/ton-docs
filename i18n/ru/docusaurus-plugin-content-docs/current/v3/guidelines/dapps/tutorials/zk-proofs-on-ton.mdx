...
В репозитории с примерами — [zk-ton-example](https://github.com/zkTokenTip/zk-ton-example/) — уже есть заготовки для **Noname**, **gnark** и **arkworks**: вы можете собрать доказательство в любом из этих стеков, затем сконвертировать его в формат snarkjs и проверить верификацию локально и on-chain таким же способом.
