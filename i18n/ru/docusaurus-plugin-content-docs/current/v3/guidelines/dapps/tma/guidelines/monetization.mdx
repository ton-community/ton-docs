...
Wallet Pay is the primary payment system for Telegram Mini Apps, supporting both crypto and fiat transactions. Отслеживайте статистику своих заказов и легко выводите средства.
...
* [Демо-магазин](https://t.me/PineAppleDemoWPStoreBot) - это Telegram-бот для демонстрации функционала Wallet Pay.

:::note
(Внимание: все платежи осуществляются в реальных активах)
:::
...
**Кошельки** представляют пользовательский интерфейс для подтверждения транзакций и надежно хранят криптографические ключи пользователей на их персональных устройствах. This separation of responsibilities enables rapid innovation and ensures a high level of security for users. Такое разделение задач обеспечивает быстрое внедрение инновации и обеспечивать высокий уровень безопасности для пользователей: кошелькам не нужно самим создавать экосистемы, а приложениям не нужно брать на себя риск хранения учетных записей конечных пользователей.
