...
Прежде чем погрузиться в DApps, убедитесь, что вы понимаете принципы, лежащие в основе блокчейна. Возможно, вам будут полезны наши статьи [The Open Network](/v3/concepts/dive-into-ton/introduction) и [Блокчейн блокчейнов](/v3/concepts/dive-into-ton/ton-blockchain/overview).
...
- [Собственный токен: Toncoin](/v3/documentation/dapps/assets/toncoin)
- [Токены (FT)](/v3/documentation/dapps/assets/jetton)
...
- [Создание простого проекта ZK на TON (устарело)](/v3/guidelines/dapps/tutorials/zero-knowledge-proofs)
- [Доказательства с нулевым разглашением в TON](/v3/guidelines/dapps/tutorials/zk-proofs-on-ton)
