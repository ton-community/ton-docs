...
- [TON HTTP API](/v3/guidelines/dapps/apis-sdks/api-types#http-api) - API, позволяющий работать с *индексированной информацией блокчейна*.
...
:::info
Предпочтительнее преобразовывать адрес с помощью локального алгоритма, дополнительную информацию ознакомьтесь в разделе документации [Адреса](/v3/documentation/smart-contracts/addresses/address).
:::
...
- [TON HTTP API](/v3/guidelines/dapps/apis-sdks/api-types#http-api)
