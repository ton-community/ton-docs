...
| [tvm_valuetypes](https://github.com/toncenter/tvm_valuetypes)               | Python                                                                                              | _только для offchain_                                                                                      | Utilities for handling TVM types.                                                                                                    |   |
| [pytvm](https://github.com/yungwine/pytvm)                                  | Python                                                                                              | _offchain_                                                                                                 | Python эмулятор TVM, использующий привязки к стандартному C++ эмулятору                                                              |   |
| [pytoniq-core](https://github.com/yungwine/pytoniq-core)                    | Python                                                                                              | _только для offchain_                                                                                      | Мощный transport-free SDK на языке Python                                                                                            |   |
