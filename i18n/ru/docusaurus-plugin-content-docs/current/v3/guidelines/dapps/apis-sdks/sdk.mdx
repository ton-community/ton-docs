...
4. Эти SDK позволяют создавать и сериализовывать ячейки, которые можно передавать в API.
...
| [ayrat555/ton](https://github.com/ayrat555/ton)                             | Elixir | *только для offchain*                                                                                      | TON SDK для Elixir.                                                                                                                  |   |
...
| [mytonlib](https://github.com/igroman787/mytonlib)                          | Python | Встроенный ADNL                                                                                            | Нативная библиотека Python SDK для работы с The Open Network                                                                         |   |
| [TonTools](https://github.com/yungwine/TonTools)                            | Python | через RPC ([Orbs](https://www.orbs.com/ton-access/) / [Toncenter](https://toncenter.com/api/v2/) / и т.д.) | TonTools - это высокоуровневая объектно-ориентированная библиотека для Python, которая позволяет взаимодействовать с блокчейном TON. |   |
| [tonpy](https://github.com/disintar/tonpy)                                  | Python | Встроенный ADNL                                                                                            | Python пакет, предоставляющий структуры данных и API для взаимодействия с блокчейном TON.                                            |   |
| [tvm_valuetypes](https://github.com/toncenter/tvm_valuetypes)               | Python | *только для offchain*                                                                                      | Utilities for handling TVM types.                                                                                                    |   |
| [pytvm](https://github.com/yungwine/pytvm)                                  | Python | *offchain*                                                                                                 | Python эмулятор TVM, использующий привязки к стандартному C++ эмулятору                                                              |   |
| [pytoniq-core](https://github.com/yungwine/pytoniq-core)                    | Python | *только для offchain*                                                                                      | Мощный transport-free SDK на языке Python                                                                                            |   |
