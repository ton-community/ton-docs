...
Этот набор упрощает реализацию TON Connect в приложениях для блокчейна TON.
Поддерживаются стандартные фреймворки фронтенда, а также приложения, не использующие предопределённые фреймворки.
