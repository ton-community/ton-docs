...
После установки пакета создайте файл `manifest.json` для вашего приложения.
Более подробную информацию о том, как создать файл manifest.json, можно найти [здесь](/v3/guidelines/ton-connect/guidelines/creating-manifest).
...
- [Документация SDK](https://github.com/ton-connect/sdk/blob/main/packages/ui/README.mdx)
