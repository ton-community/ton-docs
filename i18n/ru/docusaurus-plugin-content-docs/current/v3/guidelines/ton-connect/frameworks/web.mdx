...
После установки пакета создайте файл `manifest.json` для вашего приложения. Более подробную информацию о том, как создать файл manifest.json, можно найти [здесь](/v3/guidelines/ton-connect/creating-manifest).
...
- Подробнее о подготовке сообщений можно найти здесь: [Отправка сообщений](/v3/documentation/smart-contracts/message-management/sending-messages).
...
- [Подпись и проверка](/v3/guidelines/ton-connect/verifying-signed-in-users)
