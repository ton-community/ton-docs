...
- **Транзакции**. Создавайте определенные сообщения транзакций с помощью библиотек TON. Погрузитесь в процесс [отправки сообщений](/v3/guidelines/ton-connect/guidelines/sending-messages) с нашим полным руководством.
