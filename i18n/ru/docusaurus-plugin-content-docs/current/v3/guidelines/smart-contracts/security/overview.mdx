...
:::tip 
Прежде чем погружаться в изучение безопасности на уровне разработчика, убедитесь, что Вы хорошо разбираетесь в этой теме на уровне пользователя. Ознакомиться с курсом TON Blockchain Ознакомиться с курсом TON Blockchain Module 5 covers the basics of user-level security.\\
:::
