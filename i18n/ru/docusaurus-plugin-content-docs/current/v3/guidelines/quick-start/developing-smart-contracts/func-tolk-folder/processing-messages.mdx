...
Поскольку TON реализует [модель акторов](/v3/guidelines/dapps/transactions/foundations-of-blockchain#actor), довольно естественно думать об отношениях смарт-контрактов в контексте `ролей`, определяющих, кому доступна определённая функциональность смарт-контракта. Самые распространённые примеры ролей:
