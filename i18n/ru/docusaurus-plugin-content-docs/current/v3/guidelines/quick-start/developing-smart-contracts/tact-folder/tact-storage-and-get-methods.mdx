...
Давайте создадим и модифицируем наш смарт-контракт по стандартным шагам, описанным в предыдущем разделе [«Обзор Blueprint»](/v3/guidelines/quick-start/developing-smart-contracts/tact-folder/tact-blueprint-sdk-overview/).
