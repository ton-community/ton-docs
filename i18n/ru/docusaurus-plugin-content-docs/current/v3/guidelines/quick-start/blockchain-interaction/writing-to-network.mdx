...
Смотрите раздел [Акторы и роли](/v3/guidelines/quick-start/developing-smart-contracts/func-tolk-folder/processing-messages) для более концептуального описания.
