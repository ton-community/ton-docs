...
گره‌ها در پروتکل TON وظایف مختلفی انجام می‌دهند:
...
شما دو گزینه دارید تا به برنامه کلاینت لایت خود اجازه دهید با بلاکچین TON تعامل کند:
