...
- `contracts` - کد منبع همه قراردادهای هوشمند پروژه و وابسته‌های آن‌ها.
- `wrappers` - کلاس‌های پوششی (پیاده‌سازی `Contract` از ton-core) برای قراردادها، شامل هر [وا]سریال‌سازی ابتدای و توابع کامپایل.
- `tests` - تست‌ها برای قراردادها.
- `scripts` - اسکریپت‌های استفاده شده توسط پروژه، عمدتاً اسکریپت‌های پیاده‌سازی.
...
### پیاده‌سازی یا اجرای اسکریپت دیگر
...
- [GitHub\*](https://github.com/ton-blockchain/vesting-contract)
