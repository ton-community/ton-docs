...
| کد خروج    | توضیحات                                                                 |
| ---------- | ----------------------------------------------------------------------- |
| walletv3r1 | بررسی `valid_until` شکست خورد؛ تلاش برای تأیید تراکنش خیلی دیر انجام شد |
| walletv3r2 | بررسی `Ed25519 signature` شکست خورد                                     |
...
1. <b>workchain</b>: عدد صحیح ۸-بیتی.
...
2. <b>موجودی</b>: مقدار VARUINT16 تونکوین از موجودی اولیه.
