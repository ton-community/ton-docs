...
| `HASHEXTA_(HASH)`  | _`b s_1 ... s_n n - b'`_ | هش نتیجه به <code>b</code> اضافه می‌شود به جای آنکه به پشته ارسال شود.    |
...
| `RIST255_QVALIDATE` | _`x - ۰ or -۱`_       | Quiet version of `RIST255_VALIDATE`.<br/>_234 gas_.                                                                     |
| `RIST255_QADD`      | _`x y - ۰ or x+y -۱`_ | Quiet version of `RIST255_ADD`. <br/>_634 gas_.                                                                         |
| `RIST255_QSUB`      | _`x y - ۰ or x-y -۱`_ | Quiet version of `RIST255_SUB`.<br/>_634 gas_.                                                                          |
| `RIST255_QMUL`      | _`x n - ۰ or x*n -۱`_ | Quiet version of `RIST255_MUL`.<br/>_2034 gas_.                                                                         |
| `RIST255_QMULBASE`  | _`n - ۰ or g*n -۱`_   | Quiet version of `RIST255_MULBASE`.<br/>_784 gas_.                                                                      |
