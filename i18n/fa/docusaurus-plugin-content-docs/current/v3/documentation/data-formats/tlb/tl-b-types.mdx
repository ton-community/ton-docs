...
ساختارهای TL-B زیر برای سریال‌سازی یک Hashmap با طول ثابت کلید استفاده می‌شوند:
...
[مثال دی‌کدینگ](https://github.com/xssnick/tonutils-go/blob/3d9ee052689376061bf7e4a22037ff131183afad/address/addr.go#L156)
