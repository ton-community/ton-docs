...
<details>
  <summary><b>نمایش مثال</b></summary>
...
که در آن `i` یک شاخص ارجاع `c` و `e` میزان ارجاع `c` است.

_If an ordinary cell has no references, its level is zero._

### سطح سلول‌های عجیب و غریب
...
[//]: # "* [مقاله اصلی به RU](https://github.com/xssnick/ton-deep-doc/blob/master/Cells-BoC.md)"
