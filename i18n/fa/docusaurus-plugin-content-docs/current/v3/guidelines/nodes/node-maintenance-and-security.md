...
#### به کاربر root سوئیچ کنید

```sh
sudo  -s
```

#### فرآیندهای mytoncore و validator را متوقف کنید
...
#### فایل‌های پیکربندی گره که پشتیبان گرفته شده‌اند را اعمال کنید

- فایل پیکربندی گره: `/var/ton-work/db/config.json`

- کلید خصوصی گره: `/var/ton-work/db/keyring`

- کلیدهای عمومی گره: `/var/ton-work/keys`
...
#### اطمینان از دسترسی‌های صحیح بانک‌اطلاعاتی
...
#### فرآیندهای mytoncore و validator را آغاز کنید
...
#### قفل اولیه مجموعه قوانین ufw

```sh
sudo  ufw  default  deny  incoming; sudo  ufw  default  allow  outgoing
```

#### غیرفعال کردن پذیرش خودکار درخواست اکو ICMP
...
#### فعال‌سازی دسترسی کامل از شبکه(های) مدیریتی
...
#### شبکه‌های مدیریتی خود را دو بار بررسی کنید
...
برای بررسی وضعیت فایروال از فرمان زیر استفاده کنید:
