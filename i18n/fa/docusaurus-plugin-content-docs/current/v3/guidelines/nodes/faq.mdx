...
MyTonCtrl مؤلفه‌های والیدیتور را در دایرکتوری زیر کامپایل می‌کند:

1. `/usr/bin/ton/`

MyTonCtrl یک دایرکتوری کاری برای والیدیتور در اینجا ایجاد می‌کند:

1. `/var/ton/`

---

## اگر MyTonCtrl به صورت root نصب شده باشد

پیکربندی‌ها به صورت متفاوت ذخیره خواهند شد:
...
## چگونه MyTonCtrl را حذف کنیم

اسکریپت را به عنوان مدیر اجرا کنید و مؤلفه‌های کامپایل‌شده TON را حذف کنید:
...
- [رفع اشکال](/v3/guidelines/nodes/nodes-troubleshooting)
