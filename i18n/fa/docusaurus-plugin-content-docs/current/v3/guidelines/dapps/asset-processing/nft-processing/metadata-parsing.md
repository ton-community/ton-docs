...
| `amount_style` |            | اختیاری  | Required by external applications to understand the format of displaying the number of tokens. Defined using _n_, _n-of-total_, _%_.                                                                                                                                                                                                  |
...
- _currency_ - به عنوان ارز نمایش داده می‌شود (مقدار پیش‌فرض).
