...
| Бібліотека                                      | Blockchain connection                                                                                 | Опис                                                                                                                                   |
| ----------------------------------------------- | ----------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
...
| Бібліотека                                 | Blockchain connection | Опис                                |
| ------------------------------------------ | --------------------- | ----------------------------------- |
| [ton4j](https://github.com/neodix42/ton4j) | Tonlib binary         | Java SDK для The Open Network (TON) |
...
| [pytoniq-core](https://github.com/yungwine/pytoniq-core)      | _тільки для offchain_                                                                                                                                    | Transport-free, powerful SDK.                                     |
...
| [tvm_valuetypes](https://github.com/toncenter/tvm_valuetypes) | _тільки для offchain_                                                                                                                                    | Utilities for handling TVM types.                                 |
...
| Бібліотека                                                                  | Мова   | Blockchain connection                                                                                 | Опис                                                                   |   |
| --------------------------------------------------------------------------- | ------ | ----------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- | - |
| [ton-kotlin](https://github.com/ton-community/ton-kotlin)                   | Kotlin | Native ADNL                                                                                           | Kotlin/Multiplatform SDK для The Open Network.                         |   |
...
| [ayrat555/ton](https://github.com/ayrat555/ton)                             | Elixir | _тільки для offchain_                                                                                 | TON SDK для Elixir.                                                    |   |
