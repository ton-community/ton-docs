...
Tact 是一种适用于 TON 区块链的全新编程语言，它注重开发的效率和简便性，为 TypeScript、Rust 和 Kotlin 开发人员提供了熟悉的语法。Tact 专为初学者设计，大大缩短了入门时间，促进了 TON 的采用。

使用 Tact 简化 TON 开发并快速创建合约原型！

由 [TON Studio](https://tonstudio.io) 推出，由社区驱动。
...
<Button href="https://docs.tact-lang.org/zh-cn/"
