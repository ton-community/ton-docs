...
安装软件包后，请为您的应用程序创建一个 `manifest.json` 文件。有关如何创建 manifest.json 文件的更多信息，请参阅 [此处](/v3/guidelines/ton-connect/creating-manifest)。
...
- 在此获取更多示例：[发送信息](/v3/guidelines/ton-connect/cookbook/cells)。
...
- [签名和验证](/v3/guidelines/ton-connect/verifying-signed-in-users)
