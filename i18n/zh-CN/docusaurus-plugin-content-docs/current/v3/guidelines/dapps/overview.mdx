...
在深入研究 DApps 之前，请确保您了解区块链的基本原理。您可能会发现我们的 [The Open Network](/v3/concepts/dive-into-ton/introduction) 和 [Blockchain of Blockchains](/v3/concepts/dive-into-ton/ton-blockchain/overview) 文章很有用。
...
- [了解 Toncoin](/v3/documentation/dapps/assets/toncoin)
- [代币：Jettons 和 NFT](/v3/documentation/dapps/assets/nft)
