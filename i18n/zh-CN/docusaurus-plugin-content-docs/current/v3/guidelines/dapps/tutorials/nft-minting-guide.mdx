...
:::info
如果你想更深入地了解这个话题，可以查看[TON上的NFT处理](/v3/guidelines/dapps/asset-processing/nft-processing/nfts)文章或阅读[NFT标准](https://github.com/ton-blockchain/TEPs/blob/master/text/0062-nft-standard.md)
:::
