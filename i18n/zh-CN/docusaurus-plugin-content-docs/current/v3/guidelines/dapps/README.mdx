...
在深入研究DApps之前，请确保您理解底层的区块链原理。我们的[The Open Network](/v3/concepts/dive-into-ton/introduction)和[Blockchain of Blockchains](/learn/overviews/ton-blockchain)文章可能会对您有所帮助。
