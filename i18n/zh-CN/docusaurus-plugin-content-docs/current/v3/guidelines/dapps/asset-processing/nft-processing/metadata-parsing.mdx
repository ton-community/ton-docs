...
要解析元数据，首先必须从区块链获取 NFT 数据。为了更好地理解这个过程，请考虑阅读我们的 TON 资产处理文档章节中的[获取 NFT 数据](/v3/guidelines/dapps/asset-processing/nft-processing/nfts#retrieving-nft-data)部分。
...
- [TON NFT 处理](/v3/guidelines/dapps/asset-processing/nft-processing/nfts)
- [TON Jetton 处理](/v3/guidelines/dapps/asset-processing/jettons)
- [首次打造你的 Jetton](/v3/guidelines/dapps/tutorials/mint-your-first-token)
