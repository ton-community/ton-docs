...
免铸造 jetton  - 是 TON 区块链上标准 jetton 实现（[TEP-74](https://github.com/ton-blockchain/TEPs/blob/master/text/0074-jettons-standard.mdx)）的扩展（[TEP-177](https://github.com/ton-blockchain/TEPs/pull/177) 和 [TEP-176](https://github.com/ton-blockchain/TEPs/pull/176)）。
...
- 与 **[自定义有效载荷 API](https://github.com/ton-blockchain/TEPs/blob/master/text/0064-token-data-standard.mdx#jetton-metadata-example-offchain)** 中指定的链外 API 集成：
  - 检查每个 jetton 是否是免铸造的。
...
- 根据[元数据标准](https://github.com/ton-blockchain/TEPs/blob/master/text/0064-token-data-standard.mdx)，在令牌的元数据中添加 `mintless_merkle_dump_uri` 和 `custom_payload_api_uri`。
...
- [Jetton 链下有效载荷TEP](https://github.com/ton-blockchain/TEPs/blob/master/text/0064-token-data-standard.mdx#jetton-metadata-example-offchain)
- [Jetton元数据标准](https://github.com/ton-blockchain/TEPs/blob/master/text/0064-token-data-standard.mdx)
