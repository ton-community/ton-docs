...
- [TON HTTP API](/v3/guidelines/dapps/apis-sdks/api-types#http-api) — 允许处理_索引化区块链信息_的API。
- [TON ADNL API](/v3/guidelines/dapps/apis-sdks/api-types#adnl) — 基于ADNL协议的与TON通信的安全API。
...
:::info
最好通过本地算法转换地址，更多信息请阅读文档中的[地址](/v3/documentation/smart-contracts/addresses/address)部分。
:::
...
- [SDK列表](/v3/guidelines/dapps/apis-sdks/sdk)
