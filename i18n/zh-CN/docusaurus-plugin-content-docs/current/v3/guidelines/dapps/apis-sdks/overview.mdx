...
您可能需要与 TON 区块链进行快速交互，或收集和分析其数据。为此，运行自己的 [Ton Node](/v3/documentation/nodes/overview) 可能会有所帮助。
...
使用支持本地 [ADNL](/v3/documentation/network/protocols/adnl/tcp)的 SDK：
...
- [TON Connect 教程](/v3/guidelines/ton-connect/overview)
