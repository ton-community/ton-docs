...
从人类的角度来看，检查地址分片的最简单方法是查看地址 [原始格式](/v3/documentation/smart-contracts/addresses/address-formats#raw-address)。
...
为了理解其工作原理，我们应该了解合约地址 [depends](/v3/documentation/smart-contracts/addresses/address#account-id) 是如何依赖于其代码和数据的。
