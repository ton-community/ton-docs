...
在当前情况下，"证明" 指的是[merkle 证明](/v3/documentation/data-formats/cells/exotic#merkle-proof)，但也可以是签名数据或其他任何授权方法。
...
怎么放？
请记住，合约地址是 [由其状态定义](/v3/documentation/smart-contracts/addresses/address#account-id) 。
