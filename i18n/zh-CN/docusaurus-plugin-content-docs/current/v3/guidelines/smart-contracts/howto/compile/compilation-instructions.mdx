...
要从源代码构建FunC编译器，请执行上面描述的[通用部分](/v3/guidelines/smart-contracts/howto/compile/compilation-instructions#common)，然后：
...
要从源代码编译 FunC 编译器，请执行上述 [common part](/v3/guidelines/smart-contracts/howto/compile/compilation-instructions#common)，然后：

```bash
cmake --build . --target func
```

要构建tonlib-cli，请执行[通用部分](/v3/guidelines/smart-contracts/howto/compile/compilation-instructions#common)，[下载配置](/v3/guidelines/smart-contracts/howto/compile/compilation-instructions#download-global-config)，然后执行：
...
要从源代码编译 Fift 编译器，请执行上述 [common part](/v3/guidelines/smart-contracts/howto/compile/compilation-instructions#common)，然后：
...
要构建storage-daemon和storage-daemon-cli，请执行[通用部分](/v3/guidelines/smart-contracts/howto/compile/compilation-instructions#common)，然后执行：
...
要编译 generate-random-id，请执行 [common part](/v3/guidelines/smart-contracts/howto/compile/compilation-instructions#common)，然后执行：
