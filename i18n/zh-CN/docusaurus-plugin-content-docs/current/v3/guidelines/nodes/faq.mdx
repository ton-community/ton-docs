...
1. **Fork the project**: You can fork the project and make your modifications there. **分叉项目** - 您可以分叉项目并在其中进行修改。了解如何使用 `man git-fork` fork 项目。
...
确保您有足够的权限执行这些命令并进行必要的调整。在执行可能影响验证程序的操作前，请务必备份重要数据。 <u>**Remember to back up important data before performing operations that may affect your validator.**</u>
