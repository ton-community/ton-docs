...
在JavaScript SDK [TonWeb](https://github.com/toncenter/tonweb) 和 [TonLib](/v3/guidelines/dapps/apis-sdks/ton-adnl-apis)中实现了与TON DNS的交互。
...
将来这可能会改变。添加新的一级域名将需要新的根智能合约和改变[网络配置#4](/v3/documentation/smart-contracts/contracts-specs/governance)的通用投票。
