...
以 TON 为单位的最小赌注，详情请查看 [this param 17](/v3/documentation/network/configs/blockchain-configs#param-17)。

### Maximum stake

以 TON 为单位的最大赌注，详情请查看 [this param 17](/v3/documentation/network/configs/blockchain-configs#param-17)。
