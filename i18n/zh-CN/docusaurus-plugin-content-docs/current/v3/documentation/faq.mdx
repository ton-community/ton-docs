...
- [The Open Network简介](/v3/concepts/dive-into-ton/introduction)
- [TON区块链基于PoS共识](https://blog.ton.org/the-ton-blockchain-is-based-on-pos-consensus)
- [TON白皮书](/v3/documentation/introduction)

### TON 与 EVM 区块链的主要相似之处和不同之处是什么？

- [从以太坊到TON](/v3/concepts/dive-into-ton/go-from-ethereum/tvm-vs-evm)
- [TON、Solana和以太坊2.0的比较](https://ton.org/comparison_of_blockchains.pdf)

### TON 有测试环境吗？

- [Testnet测试网](/v3/documentation/smart-contracts/getting-started/testnet)
...
- [区块链比较表（信息量比文档少得多，但更直观）](/v3/concepts/dive-into-ton/go-from-ethereum/blockchain-comparison)
  :::
...
- [区块布局](/v3/documentation/data-formats/layout/blocks)
...
- [交易布局](/v3/documentation/data-formats/layout/transactions)
...
要更好地理解这个过程是如何工作的，请参阅[支付处理](/guidelines/advanced-asset-processing)部分。

- [智能合约地址](/v3/concepts/dive-into-ton/ton-blockchain/addresses)
- [NFT 文档](/v3/documentation/dapps/assets/nft)

Jettons（代币）：

- [智能合约地址](/v3/concepts/dive-into-ton/ton-blockchain/addresses)
- [分布式 TON 代币概述](https://telegra.ph/Scalable-DeFi-in-TON-03-30)
- [可替换标记文档（Jettons）](/v3/documentation/dapps/assets/jetton)
...
- [治理合约](/v3/documentation/smart-contracts/addresses/address)
...
- [万物皆智能合约](/v3/documentation/smart-contracts/addresses/address#everything-is-a-smart-contract)
...
:::info
在 TON 区块链概述文章中阅读更多有关主链、工作链和分片链的信息：[区块链中的区块链](/v3/concepts/dive-into-ton/ton-blockchain/overview)。
:::
...
[TON中的一切都是智能合约](/v3/documentation/smart-contracts/addresses/address#everything-is-a-smart-contract)。
...
是的，智能合约地址是区分大小写的，因为它们是使用 [base64 算法](https://en.wikipedia.org/wiki/Base64) 生成的。  你可以在 [这里](/v3/documentation/smart-contracts/addresses/address) 了解有关智能合约地址的更多信息。
...
- [网络配置](/v3/documentation/network/config-params/overview)
