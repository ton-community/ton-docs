...
> 💡 有用的链接
>
> [文档中的“If statement”](/v3/documentation/smart-contracts/func/docs/statements#if-statements)
...
> 💡 有用的链接
>
> [文档中的“Repeat loop”](/v3/documentation/smart-contracts/func/docs/statements#repeat-loop)
...
> 💡 有用的链接
>
> [文档中的“While loop”](/v3/documentation/smart-contracts/func/docs/statements#while-loop)
>
> [文档中的“Cell”](/v3/documentation/data-formats/cells/overview)
>
> [文档中的“slice_refs_empty?()”](/v3/documentation/smart-contracts/func/docs/stdlib#slice_refs_empty)
>
> [文档中的“store_ref()”](/v3/documentation/smart-contracts/func/docs/stdlib#store_ref)
>
> [文档中的“begin_cell()”](/v3/documentation/smart-contracts/func/docs/stdlib#begin_cell)
>
...
> 💡 有用的链接
>
> [文档中的“Until loop”](/v3/documentation/smart-contracts/func/docs/statements#until-loop)
...
> 💡 有用的链接
>
> [文档中的“slice_data_empty?()”](/v3/documentation/smart-contracts/func/docs/stdlib#slice_data_empty)
>
> [文档中的“store_slice()”](/v3/documentation/smart-contracts/func/docs/stdlib#store_slice)
>
> [文档中的“store_ref()”](/v3/documentation/smart-contracts/func/docs/stdlib#store_ref)
...
> 💡 有用的链接
>
> [文档中的“dict_empty?()”](/v3/documentation/smart-contracts/func/docs/stdlib#dict_empty)
>
> [文档中的“new_dict()”](/v3/documentation/smart-contracts/func/docs/stdlib/#new_dict) 创建空字典
>
...
> 💡 注意
>
> 我们声明了 tlen 汇编函数。你可以在[这里](/v3/documentation/smart-contracts/func/docs/functions#assembler-function-body-definition)阅读更多，并查看[所有汇编指令列表](/v3/documentation/tvm/instructions)。
>
> 文档中的["tpush()"](/v3/documentation/smart-contracts/func/docs/stdlib/#tpush)
>
> [文档中的 "退出代码"](/v3/documentation/tvm/exit-codes)
...
> 💡 注意
>
> 我们可以通过确定 [cell 是否为空](/v3/documentation/smart-contracts/func/cookbook#how-to-determine-if-cell-is-empty) 来确定合约的状态是否为空。
>
> 文档中的["begin_parse()"](/v3/documentation/smart-contracts/func/docs/stdlib/#begin_parse)
>
> 文档中的 ["slice_empty?()"](/v3/documentation/smart-contracts/func/docs/stdlib/#slice_empty)
...
> 💡 注意
>
> 在这个例子中，我们使用字面量 `a` 获取地址。你可以在[文档](/v3/documentation/smart-contracts/func/docs/literals_identifiers)中找到更多关于字符串字面量的信息。

> 💡 注意
>
> 你可以在[文档](/v3/documentation/data-formats/layout/messages)中找到更多信息。也可以通过这个链接跳转到[布局](/v3/documentation/data-formats/layout/messages#message-layout)。
>
> [文档中的 "store_uint() "](/v3/documentation/smart-contracts/func/docs/stdlib#store_uint)
>
> [文档中的 "store_slice() "](/v3/documentation/smart-contracts/func/docs/stdlib#store_slice)
...
> 💡 注意
>
> 我们正在[构建消息](/v3/documentation/smart-contracts/func/cookbook#how-to-build-an-internal-message-cell)，但单独添加消息体。
>
> [文档中的 "store_uint() "](/v3/documentation/smart-contracts/func/docs/stdlib#store_uint)
>
> [文档中的 "store_slice() "](/v3/documentation/smart-contracts/func/docs/stdlib#store_slice)
...
[标准 tvm 异常代码](/v3/documentation/tvm/exit-codes)
...
> 💡 Noted
>
> 在本例中，我们使用 `workchain()` 获取工作链的 ID。有关工作链 ID 的更多信息，请参阅 [docs](/v3/documentation/smart-contracts/addresses/address#workchain-id) 。
...
> 💡 有用的链接
>
> [文档中的“Lisp风格列表”](/v3/documentation/smart-contracts/func/docs/stdlib/#lisp-style-lists)
>
> [文档中的“null()”](/v3/documentation/smart-contracts/func/docs/stdlib/#null)
