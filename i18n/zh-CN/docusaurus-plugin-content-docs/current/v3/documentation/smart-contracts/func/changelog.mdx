...
- [常量](/v3/documentation/smart-contracts/func/docs/literals_identifiers#constants)
- [扩展字符串字面量](/v3/documentation/smart-contracts/func/docs/literals_identifiers#string-literals)
- [Semver 编译指令](/v3/documentation/smart-contracts/func/docs/compiler_directives#pragma-version)
- [包含](/v3/documentation/smart-contracts/func/docs/compiler_directives#pragma-version)
...
- [多行 asms](/v3/documentation/smart-contracts/func/docs/functions#multiline-asms)
- 允许对常量和 asms 的重复定义
- 允许对常量进行位操作
...
- [try/catch 语句](/v3/documentation/smart-contracts/func/docs/statements#try-catch-statements)
- [throw_arg 函数](/v3/documentation/smart-contracts/func/docs/builtins#throwing-exceptions)
