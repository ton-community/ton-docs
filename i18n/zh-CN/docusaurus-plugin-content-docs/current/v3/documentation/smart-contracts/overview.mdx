...
Developed by [TON Studio](https://tonstudio.io), powered by the community — by the end of 2024, the number of *unique code*[^1] contracts deployed on the Mainnet reached almost 28 thousand, of which about 33% were written in Tact.
