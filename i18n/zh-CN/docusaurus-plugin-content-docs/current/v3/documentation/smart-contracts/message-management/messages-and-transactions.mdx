...
> 技术上，合约可以通过特殊功能如 [Tick-Tock](/v3/documentation/data-formats/layout/transactions#tick-tock) 触发，但这个功能更多用于 TON 内部的区块链核心合约。
>
...
:::info
[交易布局](/v3/documentation/data-formats/layout/transactions) 页面上有更详细准确的说明。
:::
