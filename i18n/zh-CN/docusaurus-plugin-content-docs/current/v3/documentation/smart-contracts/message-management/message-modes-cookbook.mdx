...
[消息模式](/v3/documentation/smart-contracts/message-management/sending-messages#message-modes)部分对这些模式和标记进行了详细描述，而在本节中，我们将通过具体示例来说明它们的实际应用。 This section illustrates their practical application through specific examples.
