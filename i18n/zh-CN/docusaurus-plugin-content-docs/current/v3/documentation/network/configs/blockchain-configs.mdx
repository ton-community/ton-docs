...
:::info
更多详细信息可以在 [TON DNS & Domains](/v3/concepts/dive-into-ton/ton-blockchain/network) 文章中找到，并且在 [这里](https://github.com/ton-blockchain/TEPs/blob/master/text/0081-dns-standard.md) 有更详细的原始描述。该合约不负责销售 .ton 域名。
:::
