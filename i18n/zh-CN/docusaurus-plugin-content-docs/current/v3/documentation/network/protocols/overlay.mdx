...
我们已经在关于DHT的文章中分析了一个查找overlay节点的例子，在[搜索存储区块链状态的节点](/v3/documentation/network/protocols/dht/deep-dive#search-for-nodes-that-store-the-state-of-the-blockchain)一节中。在这一节中，我们将专注于与它们的互动。
...
请求本身并无异常，与我们[在有关 ADNL TCP 的文章中所做的](/v3/documentation/network/protocols/adnl/tcp#getmasterchaininfo)非常相似。
