...
假设我们已经通过调用NFT-DNS合约的Get方法获得了其ADNL地址，[使用DHT确定了RLDP服务的地址和端口](https://github.com/xssnick/ton-deep-doc/blob/46dbf5f820af066ab10c5639a508b4295e5aa0fb/DHT.mdx)，并[通过ADNL UDP连接到它](https://github.com/xssnick/ton-deep-doc/blob/46dbf5f820af066ab10c5639a508b4295e5aa0fb/ADNL-UDP-Internal.mdx)。
...
假设我们已经通过调用 NFT-DNS 合约的 Get 方法获得了它的 ADNL 地址，[使用 DHT 确定了 RLDP 服务的地址和端口](https://github.com/xssnick/ton-deep-doc/blob/master/DHT.mdx)，并[通过 ADNL UDP 与之连接](https://github.com/xssnick/ton-deep-doc/blob/master/ADNL-UDP-Internal.mdx)。
...
*这里是[原文链接](https://github.com/xssnick/ton-deep-doc/blob/master/RLDP.mdx)，作者是[Oleg Baranov](https://github.com/xssnick)。*
