...
因为此类即时支付的总费用如此之低，它们可以用于游戏、API 和链下应用程序中的微支付。[查看示例](/v3/documentation/dapps/defi/ton-payments#examples)。
...
- [支付处理](/guidelines/advanced-asset-processing)
- [TON Connect](/guidelines/ton-connect)
