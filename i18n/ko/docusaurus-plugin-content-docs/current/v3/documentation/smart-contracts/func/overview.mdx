...
- [10 FunC lessons](https://github.com/romanovichim/TonFunClessons_Eng/) - *@romanovichim*, using a blueprint
- [10 FunC lessons (RU)](https://github.com/romanovichim/TonFunClessons_ru/) - *@romanovichim*, using a blueprint
- [FunC quiz](https://t.me/toncontests/60/) - *Vadim*. It is good for self-checking and will take 10–15 minutes. The questions are mainly about FunС, with a few general questions about TON.
- [FunC quiz (RU)](https://t.me/toncontests/58?comment=14888/) - *Vadim*
