...
<버튼 href="/v3/guidelines/get-start-with-ton" colorType={'secondary'} sizeType={'sm'}>
...
<버튼 href="https://stepik.org/course/201294/promo"
        colorType={'primary'} sizeType={'sm'}>
...
<버튼 href="https://stepik.org/course/200976/promo"
...
<버튼 href="https://stepik.org/course/202221/promo"
        colorType={'secondary'} sizeType={'sm'}>
...
- [**FAQ**](/v3/documentation/faq) - 자주 묻는 질문
...
<버튼 href="/v3/documentation/smart-contacts/overview"
        colorType="primary" sizeType={'sm'}>
...
<버튼 href="/v3/documentation/smart-contacts/getting-started/javascript" colorType={'secondary'} sizeType={'sm'}>
...
<버튼 href="/v3/guidelines/dapps/overview/" colorType={'primary'} sizeType={'sm'}>
...
- [TON 제톤 처리](/v3/guidelines/dapps/asset-processing/jettons) - 제톤 처리의 예와 개념입니다.
